...
//Name: aov.ma
//Last modified: Wed, Mar 27, 2013 04:37:47 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.6332957210352061 1.864169805447025 19.670804982631573 ;
	setAttr ".r" -type "double3" -15.338352729619455 -1.7999999999996397 9.9441402124830524e-017 ;
createNode camera -s -n "perspShape" -p "persp";
	addAttr -ci true -sn "usedBy3dfm" -ln "usedBy3dfm" -at "message";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 27.933419251482562;
...
createNode transform -n "camera1";
	setAttr ".t" -type "double3" 0 0 10.424115173552179 ;
createNode camera -n "cameraShape1" -p "camera1";
	...
	setAttr ".ovr" 1.3;
	setAttr ".ncp" 0.01;
	setAttr ".coi" 11.068426978852198;
	setAttr ".ow" 30;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".ddin[1]" -type "string" "aov_ambient.tiff";
	setAttr ".ddin[2]" -type "string" "aov_diffuse.tiff";
	setAttr ".ddin[3]" -type "string" "aov_specular.tiff";
	setAttr -s 4 ".ddim";
	...
	setAttr ".ddit[1]" -type "string" "tiff";
	setAttr ".ddit[2]" -type "string" "tiff";
	setAttr ".ddit[3]" -type "string" "tiff";
	setAttr -s 3 ".ddpt";
