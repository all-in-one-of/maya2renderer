...
//Name: TextureBaseParticleRamp.ma
//Last modified: Thu, May 30, 2013 07:01:11 PM
//Codeset: 936
requires maya "2012";
requires "nearestPointOnMesh" "4.0";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 61.295819934489188 11.890210778716014 0.38322473698534926 ;
	setAttr ".r" -type "double3" -0.93835272959027816 90.999999999997428 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 62.302485356426644;
...
createNode transform -n "pPlane1";
	setAttr ".s" -type "double3" 19.761882561132794 19.761882561132794 19.761882561132794 ;
...
createNode pointEmitter -n "emitter1" -p "pPlane1";
	...
	setAttr ".sro" no;
	setAttr -l on ".urpp";
	setAttr ".spd" 9.6694000000000013;
...
createNode particle -n "particleShape1" -p "particle1";
	...
	addAttr -ci true -h true -sn "LifeMulti0" -ln "LifeMulti0" -dt "doubleArray";
	addAttr -ci true -sn "LifeMulti" -ln "LifeMulti" -dt "doubleArray";
	...
	setAttr ".usc" yes;
	setAttr ".scp" -type "string" "TextureBaseParticleRamp_startup";
	...
	setAttr ".LifeMulti0" -type "doubleArray" 0 ;
	setAttr ".ageNormalized0" -type "doubleArray" 0 ;
	setAttr ".rgbPP0" -type "vectorArray" 0 ;
createNode transform -n "directionalLight1";
	setAttr ".r" -type "double3" -126.00260568199104 35.306970868758903 -73.018373305138979 ;
	setAttr ".s" -type "double3" 5.7282193618383932 5.7282193618383932 5.7282193618383932 ;
createNode directionalLight -n "directionalLightShape1" -p "directionalLight1";
	setAttr -k off ".v";
	setAttr ".in" 0.66119998693466187;
createNode transform -n "directionalLight2";
	setAttr ".r" -type "double3" -69.649415967713608 17.182825512524627 -57.840948122296602 ;
	setAttr ".s" -type "double3" 5.7282193618383932 5.7282193618383932 5.7282193618383932 ;
createNode directionalLight -n "directionalLightShape2" -p "directionalLight2";
	setAttr -k off ".v";
	setAttr ".in" 0.82639998197555542;
createNode transform -n "directionalLight3";
	setAttr ".r" -type "double3" -106.86349792578322 -20.612338582315498 -248.57462961875515 ;
	setAttr ".s" -type "double3" 5.7282193618383932 5.7282193618383932 5.7282193618383932 ;
...
createNode nearestPointOnMesh -n "nearestPointOnMesh1";
	setAttr ".ip" -type "double3" 2.2152112484468347 -0.10340780150425238 -2.6003809783974514 ;
...
createNode ramp -n "ramp1";
	setAttr -s 4 ".cel";
	setAttr ".cel[0].ep" 0;
	setAttr ".cel[0].ec" -type "float3" 1.5 1.3814999 0 ;
	setAttr ".cel[1].ep" 1;
	setAttr ".cel[1].ec" -type "float3" 1 0.015999973 0.203288 ;
	setAttr ".cel[2].ep" 0.38499999046325684;
	setAttr ".cel[2].ec" -type "float3" 0 0.2331894 0.99299997 ;
	setAttr ".cel[3].ep" 0.6600000262260437;
	setAttr ".cel[3].ec" -type "float3" 0.67926472 0.27805802 0.72600001 ;
createNode place2dTexture -n "place2dTexture1";
createNode arrayMapper -n "arrayMapper1";
createNode ramp -n "ramp2";
	setAttr -s 2 ".cel";
	setAttr ".cel[0].ep" 0.20499999821186066;
	setAttr ".cel[0].ec" -type "float3" 1 1 1 ;
	setAttr ".cel[2].ep" 1;
	setAttr ".cel[2].ec" -type "float3" 0.52065998 0.52065998 0.52065998 ;
...
createNode script -n "sceneConfigurationScriptNode";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 75 -ast 1 -aet 250 ";
	setAttr ".st" 6;
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "R:/MyDocuments/maya/projects/default/rmantmp/TextureBaseParticleRamp4101.xml";
...
connectAttr "arrayMapper1.ovpp" "particleShape1.LifeMulti";
connectAttr "particleShape1.xo[0]" "particleShape1.rgbPP";
...
connectAttr "pPlaneShape1.w" "nearestPointOnMesh1.im";
...
// End of TextureBaseParticleRamp.ma
