...
//Name: dynamicload.ma
//Last modified: Thu, Jun 20, 2013 01:41:01 AM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -4.8319069940604891 1.934532330194902 4.8004967273897421 ;
	setAttr ".r" -type "double3" -16.799999999974755 -39.200000000000202 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".ovr" 1.3;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 8.1354339256251471;
...
createNode transform -s -n "front";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.84284972008296233 -0.43726729836909706 500.1 ;
createNode camera -s -n "frontShape" -p "front";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 9.2922562709620831;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 7.7988245948985728 0.014068013536944868 1.0539444051014186 ;
...
createNode transform -n "pCone1";
	...
	setAttr ".s" -type "double3" 8.3089803034810465 8.3089803034810465 8.3089803034810465 ;
	setAttr ".liqRIBGenerator" -type "string" "eval(\"source test_generator.mel\"); test_quadricProcedural(\"pCone1\",\"delight\");";
...
createNode mesh -n "pConeShape1" -p "pCone1";
	...
	setAttr ".bnr" 0;
	setAttr -s 21 ".pt[0:20]" -type "float3"  -1.7052398 1.2514945 0.48992765 
		-1.4506338 1.2514945 0.93195766 -1.0540788 1.2514945 1.2827585 -0.55438232 1.2514945 
		1.5079755 -0.00046600681 1.2514945 1.5855849 0.55345148 1.2514945 1.5079756 1.0531471 
		1.2514945 1.2827522 1.4497019 1.2514945 0.93195844 1.7043047 1.2514945 0.48992753 
		1.7920361 1.2514945 -6.1165076e-005 1.7043047 1.2514945 -0.4900474 1.4497017 1.2514945 
		-0.93207508 1.0531465 1.2514945 -1.2828765 0.55345124 1.2514945 -1.5080938 -0.00046600681 
		1.2514945 -1.5857081 -0.55438232 1.2514945 -1.5080938 -1.0540791 1.2514945 -1.2828691 
		-1.4506333 1.2514945 -0.93208224 -1.7052388 1.2514945 -0.49004883 -1.7929695 1.2514945 
		-6.1165076e-005 -0.00046600681 -1.2551886 -6.1165076e-005;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "R:/MyDocuments/maya/projects/default/rmantmp/dynamicload4029.xml";
