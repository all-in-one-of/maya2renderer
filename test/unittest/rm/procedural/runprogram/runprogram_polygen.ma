...
//Name: runprogram_polygen.ma
//Last modified: Mon, Apr 08, 2013 12:45:20 AM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.9448357502180578 26.171531981505133 15.067227020745463 ;
	setAttr ".r" -type "double3" -59.400000000001761 -14.000000000000016 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 23.202592412022575;
...
createNode transform -n "pCone1";
	...
	setAttr ".t" -type "double3" -0.85567210353496503 13.741846341995828 11.113175549588492 ;
	setAttr ".s" -type "double3" 3.4732531222485288 2.8335454611156594 2.8335454611156594 ;
	setAttr ".liqRIBGenerator" -type "string" "eval(\"source test_generator.mel\"); test_polygon(\"pCone1\");";
...
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" -0.65150440969424395 15.689649440401462 8.5243575329805026 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".ddbd[0]"  8;
	setAttr ".spth" -type "string" "://E/MyDocuments/maya/projects/default/generatedShader://E/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/lib/shaders:";
	...
	setAttr ".lrs" -type "string" "R:/MyDocuments/maya/projects/default/rmantmp/test_procedural_polygen3307.xml";
...
createNode liquidDisplacement -n "liquidDisplacement1";
	...
	setAttr ".rml" -type "string" "E:/dev/autodesk/maya/myplugin/project/liquid_/2.3.3/lib/shaders/test_displacement.sdl";
	setAttr ".rpr" -type "stringArray" 7 "texname" "sstart" "sscale" "tstart" "tscale" "amp" "amp2"  ;
	...
	setAttr ".ras" -type "Int32Array" 7 -1 -1 -1 -1 -1 -1
		 -1 ;
	setAttr ".rlc" -type "stringArray" 7 "liquidAE_LifParameter( \"texname\", \"-1\", \"string\", \"string\", \"texname\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"sstart\", \"-1\", \"float\", \"float\", \"sstart\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"sscale\", \"-1\", \"float\", \"float\", \"sscale\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"tstart\", \"-1\", \"float\", \"float\", \"tstart\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"tscale\", \"-1\", \"float\", \"float\", \"tscale\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"amp\", \"-1\", \"float\", \"float\", \"amp\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"amp2\", \"-1\", \"float\", \"float\", \"amp2\", {\"\"}, \"\", 14 );"  ;
	...
	setAttr ".texname" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/test/texture/mold_normals.tif";
