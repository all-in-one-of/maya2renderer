...
//Name: erChecker.ma
//Last modified: Fri, Jul 26, 2013 11:31:26 PM
//Codeset: 936
requires maya "2013";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 8.8206282900770532 7.3242034342834943 9.0850111879389495 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 15.632594843316507;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -0.944976288967597 0 -0.68059339110570427 ;
...
createNode transform -n "pPlane1";
	addAttr -ci true -sn "liqGeoShader" -ln "liqGeoShader" -dt "float3";
	setAttr ".t" -type "double3" -0.944976288967597 0 -0.68059339110570427 ;
...
createNode transform -n "pointLight1";
	addAttr -ci true -sn "liqGeoShader" -ln "liqGeoShader" -dt "float3";
	setAttr ".t" -type "double3" 0 2.2113505544426268 0 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "R:/MyDocuments/maya/projects/default/rmantmp/erChecker949.xml";
...
createNode erChecker -n "erChecker1";
	setAttr ".c1" -type "float3" 0 0.38931867 0 ;
	setAttr ".c2" -type "float3" 0.76336306 0.76336306 0.76336306 ;
createNode polyPlane -n "polyPlane1";
	setAttr ".w" 7.8143102116573244;
	setAttr ".h" 7.0143291565057488;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
...
connectAttr "erChecker1.msg" ":defaultTextureList1.tx" -na;
connectAttr "pointLightShape1.ltd" ":lightList1.l" -na;
connectAttr "erChecker1.oc" ":lambert1.c";
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "erChecker1.msg" ":initialMaterialInfo.t" -na;
