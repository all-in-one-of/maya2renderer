...
//Name: er_checker2.ma
//Last modified: Fri, Aug 02, 2013 11:05:06 PM
//Codeset: 936
requires maya "2013";
...
createNode transform -n "pPlane1";
	addAttr -ci true -sn "liqGeoShader" -ln "liqGeoShader" -dt "float3";
	setAttr ".t" -type "double3" 1.5277571097028524 0 0.92591427101528723 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "R:/MyDocuments/maya/projects/default/rmantmp/er_checker2198.xml";
...
createNode polyPlane -n "polyPlane1";
	setAttr ".w" 8.4118442049198059;
	setAttr ".h" 7.6151745342035122;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
createNode shadingEngine -n "er_checker1SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
createNode er_checker -n "er_checker2";
	setAttr ".rms" -type "string" "";
	setAttr ".rst" -type "string" "";
	setAttr ".c1" -type "float3" 0 1 0 ;
	setAttr ".c2" -type "float3" 0.77999997 0.77999997 0.77999997 ;
createNode shadingEngine -n "er_checker2SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
createNode er_checker2 -n "er_checker21";
	setAttr ".c1" -type "float3" 1 1 0 ;
createNode shadingEngine -n "er_checker21SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
...
relationship "link" ":lightLinker1" "er_checker1SG.message" ":defaultLightSet.message";
relationship "link" ":lightLinker1" "er_checker2SG.message" ":defaultLightSet.message";
relationship "link" ":lightLinker1" "er_checker21SG.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialShadingGroup.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialParticleSE.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" "er_checker1SG.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" "er_checker2SG.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" "er_checker21SG.message" ":defaultLightSet.message";
connectAttr "layerManager.dli[0]" "defaultLayer.id";
connectAttr "renderLayerManager.rlmi[0]" "defaultRenderLayer.rlid";
connectAttr "er_checker1SG.msg" "materialInfo1.sg";
connectAttr "er_checker2.oc" "er_checker2SG.ss";
connectAttr "er_checker2SG.msg" "materialInfo2.sg";
connectAttr "er_checker2.msg" "materialInfo2.m";
connectAttr "er_checker2.msg" "materialInfo2.t" -na;
connectAttr "er_checker21.oc" "er_checker21SG.ss";
connectAttr "er_checker21SG.msg" "materialInfo3.sg";
connectAttr "er_checker21.msg" "materialInfo3.m";
connectAttr "er_checker21.msg" "materialInfo3.t" -na;
connectAttr "er_checker1SG.pa" ":renderPartition.st" -na;
connectAttr "er_checker2SG.pa" ":renderPartition.st" -na;
connectAttr "er_checker21SG.pa" ":renderPartition.st" -na;
connectAttr "er_checker21.oc" ":initialShadingGroup.ss";
connectAttr "pPlaneShape1.iog" ":initialShadingGroup.dsm" -na;
connectAttr "er_checker2.msg" ":defaultShaderList1.s" -na;
connectAttr "er_checker21.msg" ":defaultShaderList1.s" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "er_checker2.msg" ":initialMaterialInfo.m";
connectAttr "er_checker2.msg" ":initialMaterialInfo.t" -na;
// End of er_checker2.ma
