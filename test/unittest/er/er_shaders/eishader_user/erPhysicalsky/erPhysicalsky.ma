...
//Name: erPhysicalsky.ma
//Last modified: Fri, Jul 26, 2013 11:23:35 PM
//Codeset: 936
requires maya "2013";
...
createNode transform -n "pointLight1";
	addAttr -ci true -sn "liqGeoShader" -ln "liqGeoShader" -dt "float3";
	setAttr ".t" -type "double3" 0 4.8488920504173265 0 ;
...
createNode transform -n "camera1";
	addAttr -ci true -sn "liqGeoShader" -ln "liqGeoShader" -dt "float3";
	setAttr ".t" -type "double3" -2.1905200825387934 1.4206426167670707 5.8420900514197571 ;
	setAttr ".r" -type "double3" -5.9999999999938236 340.79999999998881 -2.1049305537102247e-016 ;
createNode camera -n "cameraShape1" -p "camera1";
	...
	setAttr ".ff" 0;
	setAttr ".coi" 9.3396051616296845;
	setAttr ".ow" 30;
...
createNode transform -n "pPlane1";
	addAttr -ci true -sn "liqGeoShader" -ln "liqGeoShader" -dt "float3";
	setAttr ".t" -type "double3" 0.062676123647270376 0 -3.259661355685699 ;
...
createNode transform -n "pCube1";
	addAttr -ci true -sn "liqGeoShader" -ln "liqGeoShader" -dt "float3";
	setAttr ".t" -type "double3" 0.65469337553128426 0.89550088078997725 -3.5977610073934834 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "R:/MyDocuments/maya/projects/default/rmantmp/erPhysicalsky920.xml";
...
createNode polyPlane -n "polyPlane1";
	setAttr ".w" 7.3342481482743027;
	setAttr ".h" 11.34174151344029;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
...
createNode polyCube -n "polyCube1";
	setAttr ".w" 1.9836156706366912;
	setAttr ".h" 1.7910017615799545;
	setAttr ".d" 1.8784216615420988;
	setAttr ".cuv" 4;
createNode erPhysicalsky -n "erPhysicalsky1";
	setAttr ".dir" -type "float3" 0.5 0.5 0.5 ;
createNode erSkylight -n "erSkylight1";
...
select -ne :lightList1;
	...
	setAttr -cb on ".bnm";
select -ne :lambert1;
	setAttr ".c" -type "float3" 0 0 0.58974594 ;
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "erSkylight1.liqAssignedObjects" "pointLightShape1.liquidLightShaderNode"
		;
connectAttr "erPhysicalsky1.oc" "cameraShape1.liqEnvironmentShader";
...
connectAttr "erPhysicalsky1.oc" "erSkylight1.env";
connectAttr "pPlaneShape1.iog" ":initialShadingGroup.dsm" -na;
connectAttr "pCubeShape1.iog" ":initialShadingGroup.dsm" -na;
connectAttr "erSkylight1.msg" ":defaultShaderList1.s" -na;
connectAttr "erPhysicalsky1.msg" ":defaultTextureList1.tx" -na;
connectAttr "pointLightShape1.ltd" ":lightList1.l" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "pointLight1.iog" ":defaultLightSet.dsm" -na;
// End of erPhysicalsky.ma
