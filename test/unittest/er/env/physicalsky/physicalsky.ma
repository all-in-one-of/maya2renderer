...
//Name: physicalsky.ma
//Last modified: Mon, Mar 25, 2013 09:04:38 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 13.947166933622269 168.25887904495184 153.47739677817111 ;
	setAttr ".r" -type "double3" -47.738352729610675 5.8000000000006171 1.1988452434191048e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 220.8782526392425;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/physicalsky4447.xml";
