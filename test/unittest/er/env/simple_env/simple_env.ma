...
//Name: simple_env.ma
//Last modified: Mon, Mar 25, 2013 09:05:59 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.8263979895522371 58.047560788794499 53.840282994559445 ;
	setAttr ".r" -type "double3" -47.738352729610675 5.8000000000006171 1.1988452434191048e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 71.960426040451324;
...
createNode transform -n "pCube2";
	setAttr ".t" -type "double3" -1.1343257218534069 0.0094635677770993354 -11.225466743279018 ;
	setAttr ".r" -type "double3" 49.899286543812075 41.893634658328544 34.038894823546244 ;
	setAttr ".s" -type "double3" 1.0613070545530046 1.1228690433316142 1.2353906191918085 ;
...
createNode transform -n "camera2";
	setAttr ".t" -type "double3" 4.2490106447987799 3.0804075233008161 -4.7695317443363052 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".rc" -type "string" "cameraShape3";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/simple_env4525.xml";
...
createNode liquidShader -n "liquidShader1";
	...
	addAttr -ci true -h true -sn "rmanGroupLifCmdId" -ln "rmanGroupLifCmdId" -dt "Int32Array";
	addAttr -ci true -sn "rmanLifCtrls" -ln "rmanLifCtrls" -dt "stringArray";
	addAttr -ci true -uac -h true -sn "env_color" -ln "env_color" -at "float3" -nc 3;
	...
	setAttr ".rmanGroups" -type "stringArray" 0  ;
	setAttr ".rmanGroupLifCmdId" -type "Int32Array" 0 ;
	setAttr ".env_color" -type "float3" 0.82352942 0.52380049 0.080738172 ;
...
connectAttr "liquidShader1.oc" "cameraShape3.liqEnvironmentShader";
...
connectAttr "liquidShader1.msg" "materialInfo4.m";
connectAttr "liquidShader1.msg" "materialInfo4.t" -na;
