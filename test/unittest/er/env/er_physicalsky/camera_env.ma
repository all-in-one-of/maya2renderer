...
//Name: camera_env.ma
//Last modified: Wed, Jun 19, 2013 08:35:40 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 10.715003448282781 2.9229230105820241 10.275318874616749 ;
	setAttr ".r" -type "double3" -11.138352729602408 46.200000000000081 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 15.130662767954215;
...
createNode transform -n "pPlane1";
	setAttr ".t" -type "double3" 1.6071556879578424 0 0.67889907869938071 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".ddin[0]" -type "string" "$SCN.$CAM.$RND.#.bmp";
	...
	setAttr ".lrs" -type "string" "R:/MyDocuments/maya/projects/default/rmantmp/camera_env139.xml";
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".st" 6;
createNode er_physicalsky -n "er_physicalsky1";
	...
	addAttr -ci true -h true -k true -sn "type" -ln "type" -at "long";
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "er_physicalsky1.msg" ":perspShape.mies";
...
connectAttr "er_physicalsky1.msg" ":defaultTextureList1.tx" -na;
connectAttr "place3dTexture1.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
// End of camera_env.ma
