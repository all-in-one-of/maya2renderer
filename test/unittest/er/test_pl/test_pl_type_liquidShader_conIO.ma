...
//Last modified: Thu, May 30, 2013 07:56:44 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".t" -type "double3" -1.4517380640434177 24.28415597173186 6.4666967350159856 ;
	setAttr ".r" -type "double3" -75.338352729603372 2.2000000000000695 -1.9893129658559691e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 22.593423284691877;
...
createNode transform -n "pPlane3";
	setAttr ".t" -type "double3" 6.1916737532689297 0 -0.61665156323954129 ;
createNode mesh -n "pPlaneShape12" -p "pPlane3";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "R:/MyDocuments/maya/projects/default/rmantmp/test_pl_type_liquidShader_conIO4845.xml";
...
createNode liquidShader -n "test_pl_type_liquidShader_liquidShader1";
	...
	addAttr -ci true -h true -sn "scalar_name" -ln "scalar_name" -at "double";
	addAttr -ci true -h true -sn "vector_name" -ln "vector_name" -at "double3" -nc 3;
	addAttr -ci true -h true -sn "vector_nameX" -ln "vector_nameX" -at "double" -p "vector_name";
	addAttr -ci true -h true -sn "vector_nameY" -ln "vector_nameY" -at "double" -p "vector_name";
	addAttr -ci true -h true -sn "vector_nameZ" -ln "vector_nameZ" -at "double" -p "vector_name";
	addAttr -ci true -h true -sn "point_name" -ln "point_name" -at "double3" -nc 3;
	addAttr -ci true -h true -sn "point_nameX" -ln "point_nameX" -at "double" -p "point_name";
	addAttr -ci true -h true -sn "point_nameY" -ln "point_nameY" -at "double" -p "point_name";
	addAttr -ci true -h true -sn "point_nameZ" -ln "point_nameZ" -at "double" -p "point_name";
	addAttr -ci true -h true -sn "normal_name" -ln "normal_name" -at "double3" -nc 3;
	addAttr -ci true -h true -sn "normal_nameX" -ln "normal_nameX" -at "double" -p "normal_name";
	addAttr -ci true -h true -sn "normal_nameY" -ln "normal_nameY" -at "double" -p "normal_name";
	addAttr -ci true -h true -sn "normal_nameZ" -ln "normal_nameZ" -at "double" -p "normal_name";
	addAttr -ci true -uac -h true -sn "color_name" -ln "color_name" -at "float3" -nc 
		3;
	addAttr -ci true -h true -sn "color_nameR" -ln "color_nameR" -at "float" -p "color_name";
	addAttr -ci true -h true -sn "color_nameG" -ln "color_nameG" -at "float" -p "color_name";
	addAttr -ci true -h true -sn "color_nameB" -ln "color_nameB" -at "float" -p "color_name";
	...
	setAttr ".rio" -type "Int32Array" 7 0 0 0 0 0 0
		 0 ;
	setAttr ".rma" -type "stringArray" 7 "" "" "" "" "" "" ""  ;
	setAttr ".frequency" 7;
	...
	setAttr ".rmanParamLifCmdId" -type "Int32Array" 7 0 1 2 3
		 4 5 6 ;
	setAttr ".rmanGroups" -type "stringArray" 0  ;
	setAttr ".rmanGroupLifCmdId" -type "Int32Array" 0 ;
	setAttr ".vector_name" -type "double3" 3 3 3 ;
	setAttr ".point_name" -type "double3" 2 2 2 ;
	setAttr ".normal_name" -type "double3" 4 4 4 ;
	setAttr ".color_name" -type "float3" 0 1 0 ;
	...
	setAttr ".i_color_name" -type "float3" 0 1 0 ;
	setAttr ".i_bool_name" yes;
createNode shadingEngine -n "liquidShader1SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo18";
createNode liquidShader -n "test_pl_type_liquidShader_liquidShader2";
	addAttr -ci true -h true -sn "frequency" -ln "frequency" -at "double";
	addAttr -ci true -h true -sn "s0" -ln "s0" -dt "string";
	addAttr -ci true -h true -sn "texname" -ln "texname" -dt "string";
	addAttr -ci true -h true -sn "texname0" -ln "texname0" -dt "string";
	addAttr -ci true -h true -sn "texname1" -ln "texname1" -dt "string";
	addAttr -ci true -uac -h true -sn "c0" -ln "c0" -at "float3" -nc 3;
	addAttr -ci true -h true -sn "c0R" -ln "c0R" -at "float" -p "c0";
	addAttr -ci true -h true -sn "c0G" -ln "c0G" -at "float" -p "c0";
	addAttr -ci true -h true -sn "c0B" -ln "c0B" -at "float" -p "c0";
	...
	setAttr ".frequency" 7;
	setAttr ".s0" -type "string" "test stringATT";
	setAttr ".texname" -type "string" "a.tex";
	setAttr ".texname0" -type "string" "b.bmp";
	setAttr ".texname1" -type "string" "a.tex";
	setAttr ".c0" -type "float3" 1 1 1 ;
	setAttr ".p0" -type "double3" 2 2 2 ;
	setAttr ".v0" -type "double3" 3 3 3 ;
	setAttr ".n0" -type "double3" 4 4 4 ;
...
createNode polyPlane -n "polyPlane3";
	setAttr ".w" 7.6898542847845084;
	setAttr ".h" 7.8101290721636243;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "polyPlane3.out" "pPlaneShape12.i";
...
connectAttr "phong1.dc" "test_pl_type_liquidShader_liquidShader1.scalar_name";
connectAttr "test_pl_type_liquidShader_liquidShader1.oc" "liquidShader1SG.ss";
connectAttr "liquidShader1SG.msg" "materialInfo18.sg";
connectAttr "test_pl_type_liquidShader_liquidShader1.msg" "materialInfo18.m";
connectAttr "test_pl_type_liquidShader_liquidShader1.msg" "materialInfo18.t" -na
		;
connectAttr "test_pl_type_liquidShader_liquidShader1.int_name" "test_pl_type_liquidShader_liquidShader2.int_name"
		;
connectAttr "test_pl_type_liquidShader_liquidShader1.scalar_name" "test_pl_type_liquidShader_liquidShader2.scalar_name"
		;
connectAttr "test_pl_type_liquidShader_liquidShader1.vector_name" "test_pl_type_liquidShader_liquidShader2.vector_name"
		;
connectAttr "test_pl_type_liquidShader_liquidShader1.normal_name" "test_pl_type_liquidShader_liquidShader2.normal_name"
		;
connectAttr "test_pl_type_liquidShader_liquidShader1.point_name" "test_pl_type_liquidShader_liquidShader2.point_name"
		;
connectAttr "test_pl_type_liquidShader_liquidShader1.color_name" "test_pl_type_liquidShader_liquidShader2.color_name"
		;
connectAttr "test_pl_type_liquidShader_liquidShader1.bool_name" "test_pl_type_liquidShader_liquidShader2.bool_name"
		;
connectAttr "test_pl_type_liquidShader_liquidShader1.i_int_name" "test_pl_type_liquidShader_liquidShader2.i_int_name"
		;
connectAttr "test_pl_type_liquidShader_liquidShader1.i_scalar_name" "test_pl_type_liquidShader_liquidShader2.i_scalar_name"
		;
connectAttr "test_pl_type_liquidShader_liquidShader1.i_vector_name" "test_pl_type_liquidShader_liquidShader2.i_vector_name"
		;
connectAttr "test_pl_type_liquidShader_liquidShader1.i_point_name" "test_pl_type_liquidShader_liquidShader2.i_point_name"
		;
connectAttr "test_pl_type_liquidShader_liquidShader1.i_normal_name" "test_pl_type_liquidShader_liquidShader2.i_normal_name"
		;
connectAttr "test_pl_type_liquidShader_liquidShader1.i_color_name" "test_pl_type_liquidShader_liquidShader2.i_color_name"
		;
connectAttr "test_pl_type_liquidShader_liquidShader1.i_bool_name" "test_pl_type_liquidShader_liquidShader2.i_bool_name"
		;
connectAttr "test_pl_type_liquidShader_liquidShader2.oc" "liquidShader2SG.ss";
connectAttr "pPlaneShape12.iog" "liquidShader2SG.dsm" -na;
connectAttr "liquidShader2SG.msg" "materialInfo19.sg";
connectAttr "test_pl_type_liquidShader_liquidShader2.msg" "materialInfo19.m";
connectAttr "test_pl_type_liquidShader_liquidShader2.msg" "materialInfo19.t" -na
		;
...
connectAttr "test_pl_type_liquidShader_liquidShader1.msg" ":defaultShaderList1.s"
		 -na;
connectAttr "test_pl_type_liquidShader_liquidShader2.msg" ":defaultShaderList1.s"
		 -na;
