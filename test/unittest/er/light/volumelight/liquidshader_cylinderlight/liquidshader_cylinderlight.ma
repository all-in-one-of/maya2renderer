...
//Last modified: Thu, May 30, 2013 08:05:38 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.7110456720325227 10.802519321804148 34.815418231713565 ;
	setAttr ".r" -type "double3" -17.13835272961251 -3.4000000000006714 -9.9567589887152362e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 37.142394747123902;
...
createNode liquidCoordSys -n "volumeLightShape1CoordSys1" -p "volumeLight1";
	setAttr -k off ".v";
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "R:/MyDocuments/maya/projects/default/rmantmp/liquidshader_cylinderlight4812.xml";
