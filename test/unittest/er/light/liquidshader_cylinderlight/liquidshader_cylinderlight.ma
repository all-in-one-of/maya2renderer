...
//Name: liquidshader_cylinderlight.ma
//Last modified: Thu, May 30, 2013 08:07:50 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -3.2939438232840175 19.033053540307883 61.458625071901899 ;
	setAttr ".r" -type "double3" -17.13835272961251 -3.4000000000006714 -9.9567589887152362e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 65.072803458924994;
...
createNode transform -n "areaLight1";
	setAttr ".t" -type "double3" -0.25917485783241201 3.8701234078034465 4.0673296218151815 ;
...
createNode liquidCoordSys -n "areaLightShape1CoordSys" -p "areaLight1";
	setAttr -k off ".v";
...
createNode transform -n "pPlane1";
	setAttr ".t" -type "double3" 0 -1.3523866108202713 4.3869488143973676 ;
	setAttr ".s" -type "double3" 0.95002254594222113 0.95002254594222113 2.3235282895870535 ;
...
createNode transform -n "camera1";
	setAttr ".t" -type "double3" -0.71075529954148886 3.3780378660509887 26.282460419412342 ;
	setAttr ".r" -type "double3" -4.8000000000009919 -1.1999999999999997 0 ;
...
createNode transform -n "pPlane2";
	setAttr ".t" -type "double3" 5.4709464914966883 3.0323674367150169 4.2678045612290099 ;
	setAttr ".r" -type "double3" 0 0 90 ;
	setAttr ".s" -type "double3" 1.5581674861221999 1 2.4457612079959703 ;
...
createNode transform -n "pPlane3";
	setAttr ".t" -type "double3" -5.227896662180795 3.0601925100858356 3.8017592722718039 ;
	setAttr ".r" -type "double3" 0 0 -90 ;
	setAttr ".s" -type "double3" 1.5581674861221999 1 2.4457612079959703 ;
...
createNode transform -n "pPlane4";
	setAttr ".t" -type "double3" 0.21081666885249017 3.3595752682529696 -7.220029498641729 ;
	setAttr ".r" -type "double3" 90 0 0 ;
	setAttr ".s" -type "double3" 1 1 2.4224949146789485 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "R:/MyDocuments/maya/projects/default/rmantmp/liquidshader_cylinderlight4845.xml";
...
createNode liquidSurface -n "liquidSurface1";
	...
	addAttr -ci true -uac -h true -sn "Cs" -ln "Cs" -at "float3" -nc 3;
	addAttr -ci true -h true -sn "CsR" -ln "CsR" -at "float" -p "Cs";
	addAttr -ci true -h true -sn "CsG" -ln "CsG" -at "float" -p "Cs";
	addAttr -ci true -h true -sn "CsB" -ln "CsB" -at "float" -p "Cs";
	addAttr -ci true -uac -h true -sn "Kd" -ln "Kd" -at "float3" -nc 3;
	addAttr -ci true -h true -sn "KdR" -ln "KdR" -at "float" -p "Kd";
	addAttr -ci true -h true -sn "KdG" -ln "KdG" -at "float" -p "Kd";
	addAttr -ci true -h true -sn "KdB" -ln "KdB" -at "float" -p "Kd";
	...
	setAttr ".rlc" -type "stringArray" 5 "liquidAE_LifParameter( \"Cs\", \"-1\", \"color\", \"color\", \"Cs\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"Kd\", \"-1\", \"color\", \"color\", \"Kd\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"Ks\", \"-1\", \"float\", \"float\", \"Ks\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"roughness\", \"-1\", \"float\", \"float\", \"roughness\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"specularcolor\", \"-1\", \"color\", \"color\", \"specularcolor\", {\"\"}, \"\", 14 );"  ;
	...
	setAttr ".Cs" -type "float3" 1 0 0 ;
	setAttr ".Kd" -type "float3" 1 1 1 ;
...
createNode liquidSurface -n "liquidSurface3";
	...
	setAttr ".rio" -type "Int32Array" 5 0 0 0 0 0 ;
	setAttr ".rma" -type "stringArray" 5 "" "" "" "" ""  ;
	setAttr ".Cs" -type "float3" 0 0 1 ;
	setAttr ".Kd" -type "float3" 0.50334936 0.50334936 0.50334936 ;
	setAttr ".Ks" 0.5;
	setAttr ".roughness" 0.1;
	setAttr ".specularcolor" -type "float3" 1 1 1 ;
	setAttr ".rmanParamLifCmdId" -type "Int32Array" 5 0 1 2 3
...
createNode liquidShader -n "liquidShader1";
	...
	setAttr ".rms" -type "string" "cylinderlight";
	setAttr ".rst" -type "string" "light";
	setAttr ".rml" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_er_light/cylinderlight.dll";
	setAttr ".rpr" -type "stringArray" 4 "intensity" "lightcolor" "radius" "height"  ;
	setAttr ".rdt" -type "stringArray" 4 "uniform" "uniform" "uniform" "uniform"  ;
	setAttr ".rty" -type "stringArray" 4 "float" "color" "float" "float"  ;
	setAttr ".rdf" -type "stringArray" 4 "1.0" "1.0000001.0000001.000000" "5.0" "20.0"  ;
	setAttr ".ras" -type "Int32Array" 4 -1 -1 -1 -1 ;
	setAttr ".rlc" -type "stringArray" 4 "liquidAE_LifParameter( \"intensity\", \"-1\", \"float\", \"float\", \"intensity\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"lightcolor\", \"-1\", \"color\", \"color\", \"lightcolor\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"radius\", \"-1\", \"float\", \"float\", \"radius\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"height\", \"-1\", \"float\", \"float\", \"height\", {\"\"}, \"\", 14 );"  ;
	setAttr ".rmt" -type "stringArray" 0  ;
	setAttr ".rio" -type "Int32Array" 4 0 0 0 0 ;
	setAttr ".rma" -type "stringArray" 4 "" "" "" ""  ;
	setAttr ".intensity" 5;
	setAttr ".lightcolor" -type "float3" 1 1 0 ;
	setAttr ".rmanParamLifCmdId" -type "Int32Array" 4 0 1 2 3 ;
	setAttr ".rmanGroups" -type "stringArray" 0  ;
	setAttr ".rmanGroupLifCmdId" -type "Int32Array" 0 ;
	setAttr ".deltaangle" 0.17081945881649788;
	setAttr ".direction" -type "double3" 0 0 -1 ;
	setAttr ".spread" 0.69813170079773179;
	setAttr ".radius" 1;
	setAttr ".height" 10;
...
createNode polyPlane -n "polyPlane2";
	setAttr ".w" 5.9855777443738862;
	setAttr ".h" 8.8768410432398497;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
createNode polyPlane -n "polyPlane3";
	setAttr ".w" 5.3774911081469723;
	setAttr ".h" 10.398736192263566;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
createNode polyPlane -n "polyPlane4";
	setAttr ".w" 9.4188492633917598;
	setAttr ".h" 3.7114513401207034;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "liquidShader1.liqAssignedObjects" "areaLightShape1.liquidLightShaderNode"
		;
...
connectAttr "liquidSurface3.oc" "liquidSurface4SG.ss";
connectAttr "pPlaneShape1.iog" "liquidSurface4SG.dsm" -na;
connectAttr "liquidSurface4SG.msg" "materialInfo3.sg";
...
// End of liquidshader_cylinderlight.ma
