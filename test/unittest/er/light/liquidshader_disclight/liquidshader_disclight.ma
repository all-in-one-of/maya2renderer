...
//Last modified: Wed, Jun 19, 2013 04:37:06 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.372468335779351 14.460952816477791 14.651241248727258 ;
	setAttr ".r" -type "double3" -43.538352729613294 -6.5999999999988965 1.6008867927545696e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 21.200215976895418;
...
createNode transform -n "areaLight1";
	setAttr ".t" -type "double3" -0.56689610489447095 4.7421385238616871 1.0792584004049486 ;
...
createNode transform -n "camera1";
	setAttr ".t" -type "double3" 0.28685527898596891 8.783465773169679 8.2025018142291977 ;
	setAttr ".r" -type "double3" -51.600000000000591 0.80000000000001525 4.9701011553207177e-017 ;
createNode camera -n "cameraShape1" -p "camera1";
	...
	setAttr ".ff" 0;
	setAttr ".ovr" 1.3;
	setAttr ".coi" 15.279654846360108;
	setAttr ".ow" 30;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "R:/MyDocuments/maya/projects/default/rmantmp/liquidshader_disclight38.xml";
...
createNode liquidShader -n "liquidShader1";
	...
	setAttr ".rms" -type "string" "disclight";
	setAttr ".rst" -type "string" "light";
	setAttr ".rml" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_er_light/disclight.dll";
	setAttr ".rpr" -type "stringArray" 6 "intensity" "lightcolor" "deltaangle" "direction" "spread" "radius"  ;
	setAttr ".rdt" -type "stringArray" 6 "uniform" "uniform" "uniform" "uniform" "uniform" "uniform"  ;
	setAttr ".rty" -type "stringArray" 6 "float" "color" "float" "vector" "float" "float"  ;
	setAttr ".rdf" -type "stringArray" 6 "1.0" "1.0000001.0000001.000000" "0.1745329251994329" "0.0000000.000000-1.000000" "0.3490658503988659" "10.0"  ;
	setAttr ".ras" -type "Int32Array" 6 -1 -1 -1 -1 -1 -1 ;
	setAttr ".rlc" -type "stringArray" 6 "liquidAE_LifParameter( \"intensity\", \"-1\", \"float\", \"float\", \"intensity\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"lightcolor\", \"-1\", \"color\", \"color\", \"lightcolor\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"deltaangle\", \"-1\", \"float\", \"float\", \"deltaangle\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"direction\", \"-1\", \"vector\", \"vector\", \"direction\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"spread\", \"-1\", \"float\", \"float\", \"spread\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"radius\", \"-1\", \"float\", \"float\", \"radius\", {\"\"}, \"\", 14 );"  ;
	setAttr ".rmt" -type "stringArray" 0  ;
	setAttr ".rio" -type "Int32Array" 6 0 0 0 0 0 0 ;
	setAttr ".rma" -type "stringArray" 6 "" "" "" "" "" ""  ;
	setAttr ".intensity" 3;
	setAttr ".lightcolor" -type "float3" 1 1 1 ;
	setAttr ".rmanParamLifCmdId" -type "Int32Array" 6 0 1 2 3
		 4 5 ;
	setAttr ".rmanGroups" -type "stringArray" 0  ;
	setAttr ".rmanGroupLifCmdId" -type "Int32Array" 0 ;
...
// End of liquidshader_disclight.ma
