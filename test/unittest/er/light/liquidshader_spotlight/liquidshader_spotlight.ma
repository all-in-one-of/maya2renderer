...
//Name: liquidshader_spotlight.ma
//Last modified: Mon, Apr 22, 2013 04:47:24 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -11.945696050812982 3.1076699255267015 6.2912871502923373 ;
	setAttr ".r" -type "double3" -9.9383527297758274 297.4000000000604 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 14.353949171101245;
...
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" 0.069148479719545186 0.091950992105819473 -2.2597171043819069 ;
	setAttr ".r" -type "double3" 0 33.201593418369193 0 ;
	setAttr ".s" -type "double3" 0.91767474562472151 0.91767474562472151 0.91767474562472151 ;
...
createNode transform -n "pPlane1";
	setAttr ".t" -type "double3" 0.74743060461441324 -0.56534442322483835 -3.96020150587327 ;
...
createNode transform -n "pPlane2";
	setAttr ".t" -type "double3" -0.027989554212936696 0 -7.7916445524192053 ;
...
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" 0 0.29080977388730433 0 ;
createNode pointLight -n "pointLightShape1" -p "pointLight1";
	addAttr -ci true -sn "liquidLightShaderNode" -ln "liquidLightShaderNode" -at "message";
	setAttr -k off ".v";
	setAttr ".us" no;
createNode transform -n "camera1";
	setAttr ".t" -type "double3" 0 0.52581712758106369 2.506158309778189 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "R:/MyDocuments/maya/projects/default/rmantmp/liquidshader_spotlight2693.xml";
...
createNode polyPlane -n "polyPlane2";
	setAttr ".w" 8.4971383797893587;
	setAttr ".h" 9.1506441257675526;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
createNode liquidShader -n "liquidShader1";
	...
	setAttr ".rms" -type "string" "spotlight";
	setAttr ".rst" -type "string" "light";
	setAttr ".rml" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_er_light/spotlight.dll";
	setAttr ".rpr" -type "stringArray" 5 "intensity" "lightcolor" "deltaangle" "direction" "spread"  ;
	setAttr ".rdt" -type "stringArray" 5 "uniform" "uniform" "uniform" "uniform" "uniform"  ;
	setAttr ".rty" -type "stringArray" 5 "float" "color" "float" "vector" "float"  ;
	setAttr ".rdf" -type "stringArray" 5 "1.0" "1.0000001.0000001.000000" "0.1745329251994329" "0.0000000.000000-1.000000" "0.3490658503988659"  ;
	setAttr ".ras" -type "Int32Array" 5 -1 -1 -1 -1 -1 ;
	setAttr ".rlc" -type "stringArray" 5 "liquidAE_LifParameter( \"intensity\", \"-1\", \"float\", \"float\", \"intensity\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"lightcolor\", \"-1\", \"color\", \"color\", \"lightcolor\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"deltaangle\", \"-1\", \"float\", \"float\", \"deltaangle\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"direction\", \"-1\", \"vector\", \"vector\", \"direction\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"spread\", \"-1\", \"float\", \"float\", \"spread\", {\"\"}, \"\", 14 );"  ;
	setAttr ".rmt" -type "stringArray" 0  ;
	setAttr ".rio" -type "Int32Array" 5 0 0 0 0 0 ;
	setAttr ".rma" -type "stringArray" 5 "" "" "" "" ""  ;
	setAttr ".intensity" 1;
	setAttr ".lightcolor" -type "float3" 0.90196079 0.66752559 0.17685504 ;
	setAttr ".deltaangle" 0.17453292519943289;
...
connectAttr "liquidShader1.liqAssignedObjects" "pointLightShape1.liquidLightShaderNode"
		;
...
// End of liquidshader_spotlight.ma
