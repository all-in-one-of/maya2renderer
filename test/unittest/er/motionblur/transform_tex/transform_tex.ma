...
//Last modified: Mon, May 13, 2013 06:30:32 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.72672280634597941 1.7896945248211247 1.7807798765504832 ;
	setAttr ".r" -type "double3" -42.938352729602535 22.199999999999992 5.1528065590012595e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".ovr" 1.3;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 2.627224675996513;
...
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	...
	setAttr ".bnr" 0;
	setAttr ".pt[2]" -type "float3"  0 1.8626451e-008 0;
...
createNode transform -n "camera1";
	setAttr ".t" -type "double3" 0.030491222819782851 1.4737449173797965 0.43608678319445737 ;
	setAttr ".r" -type "double3" -75.000000000000213 7.0780550836826581e-015 8.1194288088059565e-017 ;
createNode camera -n "cameraShape1" -p "camera1";
	...
	setAttr ".ff" 0;
	setAttr ".ovr" 1.3;
	setAttr ".coi" 4.5660509273352279;
	setAttr ".ow" 30;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "R:/MyDocuments/maya/projects/default/rmantmp/transform_tex110.xml";
...
createNode animCurveTL -n "pPlane1_translateX";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 0 10 1.4985979170870711;
