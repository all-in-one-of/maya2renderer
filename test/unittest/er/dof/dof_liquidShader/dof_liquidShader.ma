...
//Name: dof_liquidShader.ma
//Last modified: Mon, Mar 25, 2013 08:51:07 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -n "pCube2";
	setAttr ".t" -type "double3" -1.1343257218534069 0.62513240726493091 -11.225466743279018 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/dof_liquidShader2448.xml";
...
createNode liquidShader -n "liquidShader1";
	...
	setAttr ".rlc" -type "stringArray" 2 "liquidAE_LifParameter( \"fstop\", \"-1\", \"float\", \"float\", \"fstop\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"fplane\", \"-1\", \"float\", \"float\", \"fplane\", {\"\"}, \"\", 14 );"  ;
	setAttr ".rmt" -type "stringArray" 0  ;
...
connectAttr "liquidShader1.oc" "cameraShape3.liqLensShader";
...
connectAttr "cameraShape3.fs" "liquidShader1.fstop";
connectAttr "cameraShape3.ncp" "liquidShader1.fplane";
