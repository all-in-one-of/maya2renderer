...
//Name: uvcoord.ma
//Last modified: Fri, Apr 19, 2013 04:25:32 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.89918853948625399 1.9454818077492695 1.3434504967516943 ;
	setAttr ".r" -type "double3" -59.138352729604151 0.20000000000014923 1.1181705674797638e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".ovr" 1.3;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 1.1005144425171904;
...
createNode transform -s -n "top";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.37877820350128155 100.1 -0.11018824328210369 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 2.3765542817819183;
...
createNode transform -n "pPlane9";
	setAttr ".t" -type "double3" 0.3535858383124143 0 0.25620524343319451 ;
createNode mesh -n "pPlaneShape18" -p "pPlane9";
	...
	setAttr ".bnr" 0;
	setAttr -s 4 ".pt[0:3]" -type "float3"  3.8029587 0 -3.0976782 -2.7662225 
		0 -3.113498 3.800066 0 2.1001637 -2.7890329 0 2.1273766;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "R:/MyDocuments/maya/projects/default/rmantmp/uvcoord4316.xml";
...
createNode script -n "uiConfigurationScriptNode";
	setAttr ".b" -type "string" (
		...
		+ "\t\tdevicePanel -edit -l (localizedPanelLabel(\"Devices\")) -mbv $menusOkayInPanels  $panelName;\n\t\tif (!$useSceneConfig) {\n\t\t\tpanel -e -l $label $panelName;\n\t\t}\n\t}\n\n\n\t$panelName = `sceneUIReplacement -getNextScriptedPanel \"webBrowserPanel\" (localizedPanelLabel(\"Web Browser\")) `;\n\tif (\"\" == $panelName) {\n\t\tif ($useSceneConfig) {\n\t\t\t$panelName = `scriptedPanel -unParent  -type \"webBrowserPanel\" -l (localizedPanelLabel(\"Web Browser\")) -mbv $menusOkayInPanels `;\n\t\t}\n\t} else {\n\t\t$label = `panel -q -label $panelName`;\n\t\tscriptedPanel -edit -l (localizedPanelLabel(\"Web Browser\")) -mbv $menusOkayInPanels  $panelName;\n\t\tif (!$useSceneConfig) {\n\t\t\tpanel -e -l $label $panelName;\n\t\t}\n\t}\n\n\n\tif ($useSceneConfig) {\n        string $configName = `getPanel -cwl (localizedPanelLabel(\"Current Layout\"))`;\n        if (\"\" != $configName) {\n\t\t\tpanelConfiguration -edit -label (localizedPanelLabel(\"Current Layout\")) \n\t\t\t\t-defaultImage \"\"\n\t\t\t\t-image \"\"\n\t\t\t\t-sc false\n\t\t\t\t-configString \"global string $gMainPane; paneLayout -e -cn \\\"quad\\\" -ps 1 50 68 -ps 2 50 68 -ps 3 50 32 -ps 4 50 32 $gMainPane;\"\n"
...
createNode file -n "file1";
	setAttr ".ftn" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/test/texture/check.14.jpg";
...
createNode polyTweakUV -n "polyTweakUV1";
	setAttr ".uopa" yes;
	setAttr ".uvtk[2]" -type "float2" 0.01313544 -0.0034323537;
createNode deleteComponent -n "deleteComponent1";
	setAttr ".dc" -type "componentList" 1 "map[2]";
createNode deleteComponent -n "deleteComponent2";
	setAttr ".dc" -type "componentList" 1 "map[2]";
createNode polyTweakUV -n "polyTweakUV2";
	setAttr ".uopa" yes;
	setAttr ".uvtk[2]" -type "float2" -0.00023766799 0.011051549;
createNode deleteComponent -n "deleteComponent3";
	setAttr ".dc" -type "componentList" 1 "map[2]";
createNode polyTweakUV -n "polyTweakUV3";
	setAttr ".uopa" yes;
	setAttr -s 3 ".uvtk";
	setAttr ".uvtk[2:3]" -type "float2" -0.011911944 0.16974516  4.4703484e-008 
		0.17774865 ;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -cb on ".ihi";
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "polyTweakUV3.out" "pPlaneShape18.i";
connectAttr "polyTweakUV3.uvtk[0]" "pPlaneShape18.uvst[0].uvtw";
...
connectAttr "pPlane9.tx" "place2dTexture1.u";
...
connectAttr "polyTriangulate3.out" "polyTweakUV1.ip";
