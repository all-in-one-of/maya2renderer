...
//Name: mia_physicalsky.ma
//Last modified: Sun, Jun 16, 2013 02:21:13 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -25.603399948937266 42.673547641266993 88.127480663696275 ;
	setAttr ".r" -type "double3" -24.938352729576888 -16.200000000004856 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 101.20779913310285;
...
createNode transform -n "pPlane1";
	setAttr ".t" -type "double3" 2.8190096199491137 0 2.375577821135149 ;
...
createNode transform -n "pCylinder1";
	setAttr ".t" -type "double3" 2.1467279194073505 2.9466294017116232 2.5602229177428235 ;
...
createNode transform -n "sunDirection";
	setAttr ".t" -type "double3" 0 7.1761659996061464 0 ;
	setAttr ".r" -type "double3" -20.610602122901746 0 0 ;
	setAttr ".s" -type "double3" 6.6448867317901898 6.6448867317901898 6.6448867317901898 ;
...
createNode polyPlane -n "polyPlane1";
	setAttr ".w" 16.769825499981188;
	setAttr ".h" 15.373351256035733;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
createNode polyCylinder -n "polyCylinder1";
	setAttr ".r" 2.7875000258674838;
	setAttr ".h" 7.9457142931049951;
	setAttr ".sa" 3;
	setAttr ".sc" 1;
	setAttr ".cuv" 3;
...
createNode mia_physicalsky -n "mia_physicalsky1";
	...
	setAttr ".S02" -type "float3" 0.025641026 9.9999997e-005 9.9999997e-005 ;
	setAttr ".S18" yes;
createNode mia_ciesky -n "mia_ciesky1";
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "R:/MyDocuments/maya/projects/default/rmantmp/test_68.xml";
...
connectAttr "mia_ciesky1.msg" ":defaultShaderList1.s" -na;
