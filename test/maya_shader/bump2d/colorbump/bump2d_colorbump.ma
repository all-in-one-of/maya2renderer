...
//Last modified: Wed, Apr 03, 2013 11:03:10 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -n "camera1";
	setAttr ".t" -type "double3" 1.0847399533035451 11.706354293850589 16.367168974118758 ;
	setAttr ".r" -type "double3" -51.000000000001286 -0.80000000000000215 9.9402023106414354e-017 ;
createNode camera -n "cameraShape1" -p "camera1";
	...
	setAttr ".ff" 0;
	setAttr ".ovr" 1.3;
	setAttr ".coi" 18.460659536732408;
	setAttr ".ow" 30;
...
createNode mesh -n "pPlaneShape5" -p "pPlane5";
	...
	setAttr -s 2 ".pt[0:1]" -type "float3"  0 0 3.8453732 0 0 3.8453732;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "R:/MyDocuments/maya/projects/default/rmantmp/bump2d_colorbump2399.xml";
...
createNode bump2d -n "bump2d1";
	setAttr ".bd" 0.54054051637649536;
...
createNode polyPlane -n "polyPlane5";
	setAttr ".w" 10.686463071393337;
	setAttr ".h" 5.4875522004451085;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
createNode polyTweakUV -n "polyTweakUV1";
	setAttr ".uopa" yes;
	setAttr -s 4 ".uvtk[0:3]" -type "float2" 0.005870901 0.019660223 -0.0035030933
		 0.02171832 0 0.48062524 0 0.48062524;
...
connectAttr "polyPlane5.out" "polyTweakUV1.ip";
connectAttr "file2.oc" "phong6.n";
connectAttr "phong6.oc" "phong6SG.ss";
connectAttr "pPlaneShape5.iog" "phong6SG.dsm" -na;
