...
//Last modified: Thu, Jun 21, 2012 11:12:52 PM
//Codeset: 936
requires maya "2012";
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/er_env_physicalsky.xml";
...
createNode liquidSurface -n "liquidSurface3";
	addAttr -ci true -uac -h true -k true -sn "env_color" -ln "env_color" -at "float3" 
		-nc 3;
	addAttr -ci true -h true -k true -sn "env_colora" -ln "env_colora" -at "float" -p "env_color";
	addAttr -ci true -h true -k true -sn "env_colorb" -ln "env_colorb" -at "float" -p "env_color";
	addAttr -ci true -h true -k true -sn "env_colorc" -ln "env_colorc" -at "float" -p "env_color";
	...
	setAttr ".rlc" -type "stringArray" 1 "liquidAE_LifColor( \"env_color\", -1, \"color\", \"env_color\", {\"0\", \"0\"}, \"\", 14 );"  ;
	setAttr ".rmt" -type "stringArray" 0  ;
	setAttr ".rio" -type "Int32Array" 1 0 ;
	setAttr -k on ".env_color" -type "float3" 1 0.97347999 0.06400001 ;
...
createNode liquidSurface -n "liquidSurface4";
	...
	setAttr -k on ".sun_dir" -type "double3" 0 1 0 ;
...
createNode liquidSurface -n "liquidSurface5";
	...
	setAttr ".rlc" -type "stringArray" 18 "liquidAE_LifVector( \"sun_dir\", -1, \"vector\", \"sun_dir\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"sun_disk_size\", -1, \"float\", \"sun_disk_size\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"sun_disk_intensity\", -1, \"float\", \"sun_disk_intensity\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"sun_glow_size\", -1, \"float\", \"sun_glow_size\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"sun_glow_intensity\", -1, \"float\", \"sun_glow_intensity\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"sun_glow_falloff\", -1, \"float\", \"sun_glow_falloff\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifColor( \"ground_color\", -1, \"color\", \"ground_color\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"ground_blur\", -1, \"float\", \"ground_blur\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"visibility_to_camera\", -1, \"float\", \"visibility_to_camera\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"type\", -1, \"float\", \"type\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"haze\", -1, \"float\", \"haze\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifColor( \"zenith_color\", -1, \"color\", \"zenith_color\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"a\", -1, \"float\", \"a\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"b\", -1, \"float\", \"b\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"c\", -1, \"float\", \"c\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"d\", -1, \"float\", \"d\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"e\", -1, \"float\", \"e\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"intensity\", -1, \"float\", \"intensity\", {\"0\", \"0\"}, \"\", 14 );"  ;
	setAttr ".rmt" -type "stringArray" 0  ;
