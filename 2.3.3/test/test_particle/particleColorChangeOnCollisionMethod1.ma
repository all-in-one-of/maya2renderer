...
//Name: particleColorChangeOnCollisionMethod1.ma
//Last modified: Thu, Oct 18, 2012 08:57:21 PM
//Codeset: 936
requires maya "2012";
requires "liquid_2012x32d" "2.3.5 (buildtime= 0:41:28.82)";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.74669970990618495 15.20114292545235 -32.219795084246925 ;
	setAttr ".r" -type "double3" -23.138352729600093 -178.19999999999447 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 36.830325195385036;
...
createNode transform -n "pPlane1";
	setAttr ".s" -type "double3" 23.849116819857763 23.849116819857763 23.849116819857763 ;
...
createNode nParticle -n "nParticleShape1" -p "nParticle1";
	...
	addAttr -ci true -sn "parentU" -ln "parentU" -dt "doubleArray";
	addAttr -ci true -h true -sn "parentU0" -ln "parentU0" -dt "doubleArray";
	addAttr -ci true -sn "parentV" -ln "parentV" -dt "doubleArray";
	...
	addAttr -ci true -sn "collisionTime" -ln "collisionTime" -dt "doubleArray";
	addAttr -ci true -h true -sn "collisionTime0" -ln "collisionTime0" -dt "doubleArray";
	addAttr -ci true -sn "collisionU" -ln "collisionU" -dt "doubleArray";
	addAttr -ci true -h true -sn "collisionU0" -ln "collisionU0" -dt "doubleArray";
	addAttr -ci true -sn "collisionV" -ln "collisionV" -dt "doubleArray";
	addAttr -ci true -h true -sn "collisionV0" -ln "collisionV0" -dt "doubleArray";
	setAttr -k off ".v";
	...
	setAttr -s 5 ".xi";
	setAttr -s 4 ".xo";
	setAttr ".irbx" -type "string" "if(.I[0] !=0)\r\n{\r\n\tif(.I[1]> -1 || .I[2]>-1)\r\n\t{\r\n\t\t.O[0]=<<0,1,0>>;\r\n\t}\r\n\r\n}";
	setAttr ".irax" -type "string" "";
	setAttr ".icx" -type "string" ".O[0]=<<1,1,1>>;\r\n.O[1]=.I[3];\r\n.O[2]=.I[4];\r\n.O[3]=1;";
	setAttr ".mxc" 5000;
	setAttr ".cts" 66;
	setAttr ".gw[0]"  1;
	setAttr ".chw" 70;
	...
	setAttr ".collisionTime0" -type "doubleArray" 0 ;
	setAttr ".collisionU0" -type "doubleArray" 0 ;
	setAttr ".collisionV0" -type "doubleArray" 0 ;
...
createNode nRigid -n "nRigidShape1" -p "nRigid1";
	...
	setAttr -k off ".trd";
	setAttr -k off ".prt";
	setAttr ".thss" 0.016519999131560326;
	setAttr ".fron" 0;
	setAttr ".actv" no;
	setAttr ".scld" no;
...
createNode nRigid -n "nRigidShape2" -p "nRigid2";
	...
	setAttr ".actv" no;
	setAttr ".scld" no;
	setAttr ".por" 0.065726727247238159;
	setAttr ".tpc" yes;
	setAttr -s 2 ".fsc[0:1]"  0 1 1 1 0 1;
	setAttr -s 2 ".pfdo[0:1]"  0 1 1 1 0 1;
	setAttr -k on ".lifespan" 1;
...
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" -10.784489121435964 2.7366584709376829 0 ;
createNode pointLight -n "pointLightShape1" -p "pointLight1";
	setAttr -k off ".v";
	setAttr ".cl" -type "float3" 1 0 0 ;
	setAttr ".us" no;
createNode transform -n "pointLight2";
	setAttr ".t" -type "double3" 9.6552816064097424 3.5814042259686225 0 ;
...
createNode animCurveTL -n "pTorus1_translateX";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  20 -5.8227838180388511 24 -5.8227838180388511
		 28 -5.8227838180388511 34 -5.8227838180388511 38 -1.3554662432767612 48 0.54077295134794401
		 55 3.6054662158100839 64 8.1884265610932356 70 14.059263568219253;
createNode animCurveTL -n "pTorus1_translateY";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  20 1.8405559896378323 24 -0.074649111366900334
		 28 1.9488691595366208 34 -0.16597190763704872 38 2.4063573899363675 48 -0.20774514401749311
		 55 1.7515657817516461 64 0.17339835664038605 70 2.0632979685072224;
createNode animCurveTL -n "pTorus1_translateZ";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  20 4.8805310105891557 24 1.5951772198687726
		 28 -2.2033043307167102 34 -5.9520009604991682 38 -7.9428254050830231 48 -7.9428254050830231
		 55 -7.9428254050830231 64 -7.9428254050830231 70 -7.9428254050830231;
createNode animCurveTL -n "pSphere1_translateX";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  20 4.0307563375601667 26 6.003653525132286
		 36 7.8353846927786357 52 -0.78818661662680389 68 14.673094044609334 69 15.68243045421687;
createNode animCurveTL -n "pSphere1_translateY";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  20 3.0529798339511962 26 -0.26864962301581241
		 36 -0.40019471442173904 52 0.081459821941501698 68 0.39338195040696933 69 1.3631964241109293;
createNode animCurveTL -n "pSphere1_translateZ";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  20 -6.4672943257681696 26 -5.1510330920704623
		 36 -2.3986302372863078 52 6.4370518783018777 68 6.0346353884598756 69 5.9929893676796473;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/particleColorChangeOnCollisionMethod161.xml";
...
connectAttr "nParticleShape1.collisionTime" "nParticleShape1.xi[0]";
connectAttr "nParticleShape1.collisionU" "nParticleShape1.xi[1]";
connectAttr "nParticleShape1.collisionV" "nParticleShape1.xi[2]";
connectAttr "nParticleShape1.parentU" "nParticleShape1.xi[3]";
connectAttr "nParticleShape1.parentV" "nParticleShape1.xi[4]";
connectAttr "pPlaneShape1.w" "nParticleShape1.ggeo[0]";
connectAttr "nParticleShape1.xo[0]" "nParticleShape1.rgbPP";
connectAttr "nParticleShape1.xo[1]" "nParticleShape1.goalU";
connectAttr "nParticleShape1.xo[2]" "nParticleShape1.goalV";
connectAttr "nParticleShape1.xo[3]" "nParticleShape1.goalPP";
...
// End of particleColorChangeOnCollisionMethod1.ma
