...
//Name: er_rm_shader_graph_phong.ma
//Last modified: Thu, Jun 21, 2012 11:06:40 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 8.4393836939862439 87.589096609246894 47.018788394623037 ;
	setAttr ".r" -type "double3" -68.138352729606041 3.4000000000001918 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 96.890349287815681;
...
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" 13.137122491594528 15.475898055184418 13.821261206432473 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/er_rm_shader_graph_phong.xml";
...
createNode phong -n "phong1";
	...
	setAttr ".it" -type "float3" 0.14049999 0.14049999 0.14049999 ;
...
// End of er_rm_shader_graph_phong.ma
