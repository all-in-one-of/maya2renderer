...
//Name: er_rm_shader_graph_phong_test.ma
//Last modified: Sat, Mar 17, 2012 07:30:50 PM
//Codeset: 936
requires maya "2009";
requires "liquid_2009x32d" "2.3.5 (buildtime=23:16:04.85)";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.7133569295732132 74.245447387606433 80.66284635953059 ;
	setAttr ".r" -type "double3" -42.338352729617327 3.8000000000004444 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 119.00284152685403;
...
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" 38.667636539929589 -4.9037349080242407 -22.568872842286311 ;
createNode pointLight -n "pointLightShape1" -p "pointLight1";
	setAttr -k off ".v";
	setAttr ".in" 0.5;
	setAttr ".us" no;
createNode transform -n "pPlane1";
	setAttr ".t" -type "double3" -13.396583833261584 -7.7842579858629044 -10.333499151844144 ;
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	...
	setAttr ".duv" yes;
	setAttr ".din" 301989888;
	setAttr ".bw" 3;
createNode transform -n "pPlane2";
	setAttr ".t" -type "double3" 35.217863541060353 -4.719357986791179 16.643518630371499 ;
	setAttr ".s" -type "double3" 1 1 1.3083826678979742 ;
...
createNode transform -n "pPlane3";
	setAttr ".t" -type "double3" -0.22952781098354436 -15.592467739537319 -14.718915085509366 ;
	setAttr ".s" -type "double3" 1 1 1.4560288501489593 ;
...
createNode transform -n "pPlane4";
	setAttr ".t" -type "double3" 2.0758230629824226 -20.253388523707624 -18.991569613694537 ;
	setAttr ".s" -type "double3" 4.3696974643342434 3.7313115250827877 6.8152961826341709 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/er_rm_shader_graph_phong_test.xml";
...
createNode polyPlane -n "polyPlane1";
	setAttr ".w" 37.004738622169995;
	setAttr ".h" 33.401981967037884;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
createNode phong -n "phong1";
	...
	setAttr ".dc" 0.82642000913619995;
	setAttr ".tcf" 7.9999997979030013e-005;
	setAttr ".trsd" 0;
	setAttr ".sc" -type "float3" 0 0 0 ;
	setAttr ".rfl" 5.999999848427251e-005;
	setAttr ".rc" -type "float3" 0.16528 0.16528 0.16528 ;
	setAttr ".cp" 26.299999237060547;
...
createNode file -n "file1";
	setAttr ".ftn" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_shader_graph/texture/check112.bmp";
createNode place2dTexture -n "place2dTexture1";
createNode polyTweakUV -n "polyTweakUV1";
	setAttr ".uopa" yes;
	setAttr -s 3 ".uvtk";
	setAttr ".uvtk[2:3]" -type "float2" 0 0.095550761  -0.0022775806 0.09613733 ;
createNode file -n "file2";
	setAttr ".ag" 0.87603998184204102;
	setAttr ".ao" 0.16527999937534332;
	setAttr ".ftn" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_shader_graph/texture/check_diamond.bmp";
createNode place2dTexture -n "place2dTexture2";
createNode polyPlane -n "polyPlane2";
	setAttr ".w" 33.356266791146432;
	setAttr ".h" 23.082354412174936;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
...
createNode polyTweakUV -n "polyTweakUV2";
	setAttr ".uopa" yes;
	setAttr -s 3 ".uvtk";
	setAttr ".uvtk[2:3]" -type "float2" 0.0021049888 0.30522341  -0.0019747708 
		0.30609021 ;
createNode file -n "file3";
createNode place2dTexture -n "place2dTexture3";
createNode polyPlane -n "polyPlane3";
	setAttr ".w" 56.247905181468958;
	setAttr ".h" 39.124849348182977;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
createNode phong -n "phong5";
	...
	setAttr ".it" -type "float3" 0.2314 0.2314 0.2314 ;
	setAttr ".gi" 0.00030000001424923539;
...
createNode polyPlane -n "polyPlane4";
	setAttr ".w" 61.414612827839193;
	setAttr ".h" 41.790772640979867;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
...
createNode checker -n "checker1";
	setAttr ".ail" yes;
	setAttr ".c1" -type "float3" 0.71073997 0.71073997 0.71073997 ;
	setAttr ".c2" -type "float3" 0.36364001 0.36364001 0.36364001 ;
...
createNode bump2d -n "bump2d4";
	setAttr ".bd" 1.6116000413894653;
	setAttr ".bf" 1.0909199714660645;
	setAttr ".bfo" 0.09920000284910202;
	setAttr ".vc1" -type "float3" 0 0.94241005 0 ;
	setAttr ".vc2" -type "float3" 0.099200003 0.099200003 0 ;
...
connectAttr "phong3SG.msg" "lightLinker1.lnk[5].olnk";
connectAttr ":defaultLightSet.msg" "lightLinker1.lnk[6].llnk";
connectAttr "phong4SG.msg" "lightLinker1.lnk[6].olnk";
...
connectAttr "phongE2SG.msg" "lightLinker1.lnk[9].olnk";
...
connectAttr "phong3SG.msg" "lightLinker1.slnk[5].solk";
connectAttr ":defaultLightSet.msg" "lightLinker1.slnk[6].sllk";
connectAttr "phong4SG.msg" "lightLinker1.slnk[6].solk";
...
connectAttr "phongE2SG.msg" "lightLinker1.slnk[9].solk";
connectAttr "layerManager.dli[0]" "defaultLayer.id";
connectAttr "renderLayerManager.rlmi[0]" "defaultRenderLayer.rlid";
connectAttr "file1.oc" "phong1.c";
connectAttr "file2.ot" "phong1.it";
...
connectAttr "file1.oc" "phong4.c";
connectAttr "file2.oc" "phong4.it";
...
connectAttr "bump2d4.o" "phong5.n";
...
connectAttr "fractal1.oa" "bump2d3.bv";
...
connectAttr "file5.oa" "bump2d4.bv";
...
// End of er_rm_shader_graph_phong_test.ma
