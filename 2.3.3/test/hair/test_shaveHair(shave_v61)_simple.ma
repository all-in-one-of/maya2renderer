...
//Last modified: Wed, Apr 18, 2012 11:39:22 PM
//Codeset: 936
requires maya "2009";
requires "liquid_2009x32d" "2.3.5 (buildtime=23:09:09.70)";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.82989281041793761 0.8903319657855876 1.0826357426574842 ;
	setAttr ".r" -type "double3" -33.938352729602592 45.000000000000163 0 ;
...
createNode shaveHair -n "shaveHairShape1" -p "shaveHair1";
 ...
 4161536 0 0 0;
	...
	setAttr ".tf" yes;
	setAttr ".cbn" -type "double3" -0.43360859155654907 -9.8721319425574281e-017 -0.57641929388046265 ;
	setAttr ".cbx" -type "double3" 0.3375076949596405 0.25555524230003357 0.59855484962463379 ;
	setAttr ".slk" no;
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" 0 0.56661960001841361 0 ;
...
createNode liquidSurface -n "liquidSurface1";
	...
	setAttr -k on ".Cs" -type "double3" 0.3 0.6 0.3 ;
	setAttr -k on ".Kd" -type "double3" 0.7 0.7 0.7 ;
	setAttr ".Ks" 0.5;
...
connectAttr "shaveHairShape1.iog" "liquidSurface1SG.dsm" -na;
