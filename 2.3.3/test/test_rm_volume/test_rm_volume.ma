...
//Name: test_rm_volume.ma
//Last modified: Fri, Aug 17, 2012 11:12:54 PM
//Codeset: 936
requires maya "2012";
requires "liquid_2012x32d" "2.3.5 (buildtime=22:18:52.90)";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 21.917788770155322 5.0439761176925186 0.57670844794279774 ;
	setAttr ".r" -type "double3" -16.538352729601879 91.80000000000021 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 21.326200491800734;
...
createNode transform -n "pPlane1";
	setAttr ".t" -type "double3" 0.45221200286430729 0 2.0032613609623322 ;
	setAttr ".s" -type "double3" 2.3139609770176444 2.3139609770176444 2.3139609770176444 ;
...
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" 0 7.5325417760468731 0 ;
...
createNode polyPlane -n "polyPlane1";
	setAttr ".w" 11.54172794906286;
	setAttr ".h" 6.2898630139439966;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_rm_volume32512.xml";
...
createNode liquidVolume -n "liquidVolume1";
	addAttr -ci true -h true -sn "distance" -ln "distance" -at "double";
	addAttr -ci true -uac -h true -k true -sn "background" -ln "background" -at "float3" 
		-nc 3;
	addAttr -ci true -h true -k true -sn "backgrounda" -ln "backgrounda" -at "float" 
		-p "background";
	addAttr -ci true -h true -k true -sn "backgroundb" -ln "backgroundb" -at "float" 
		-p "background";
	addAttr -ci true -h true -k true -sn "backgroundc" -ln "backgroundc" -at "float" 
		-p "background";
	setAttr ".rms" -type "string" "fog";
	setAttr ".rst" -type "string" "volume";
	setAttr ".rml" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/lib/shaders/fog.slo";
	setAttr ".rpr" -type "stringArray" 2 "distance" "background"  ;
	setAttr ".rdt" -type "stringArray" 2 "uniform" "uniform"  ;
	setAttr ".rty" -type "stringArray" 2 "float" "color"  ;
	setAttr ".rdf" -type "stringArray" 2 "1.0" "0.0000000.0000000.000000"  ;
	setAttr ".ras" -type "Int32Array" 2 -1 -1 ;
	setAttr ".rlc" -type "stringArray" 2 "liquidAE_LifFloat( \"distance\", -1, \"float\", \"distance\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifColor( \"background\", -1, \"color\", \"background\", {\"0\", \"0\"}, \"\", 14 );"  ;
	setAttr ".rmt" -type "stringArray" 1 "volume"  ;
	setAttr ".rio" -type "Int32Array" 2 0 0 ;
	setAttr ".distance" 20;
	setAttr -k on ".background" -type "float3" 0 0.52703136 0 ;
createNode shadingEngine -n "liquidVolume1SG";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
...
relationship "link" ":lightLinker1" "liquidVolume1SG.message" ":defaultLightSet.message";
...
relationship "shadowLink" ":lightLinker1" "liquidVolume1SG.message" ":defaultLightSet.message";
connectAttr "layerManager.dli[0]" "defaultLayer.id";
connectAttr "renderLayerManager.rlmi[0]" "defaultRenderLayer.rlid";
connectAttr "liquidShader1SG.msg" "materialInfo1.sg";
connectAttr "liquidSurface1.oc" "liquidSurface1SG.ss";
connectAttr "pPlaneShape1.iog" "liquidSurface1SG.dsm" -na;
...
connectAttr "liquidVolume1.oc" "liquidVolume1SG.vs";
connectAttr "liquidVolume1SG.msg" "materialInfo5.sg";
...
connectAttr "liquidVolume1SG.pa" ":renderPartition.st" -na;
