...
bsdf_model|uniform|string|0|"specular_brdf"|-1
specular_brdf_reflectance|uniform|color|0|<<1.0,1.0,1.0>>|-1
specular_brdf_reflectance_multiplier|uniform|color|0|<<1.0,1.0,1.0>>|-1
