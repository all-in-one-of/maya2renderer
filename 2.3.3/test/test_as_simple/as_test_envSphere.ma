...
//Name: as_test_envSphere.ma
//Last modified: Tue, Jul 31, 2012 10:34:54 PM
//Codeset: 936
requires maya "2012";
requires "liquid_2012x32d" "2.3.5 (buildtime=22:31:24.67)";
requires "liquid_2012x32d" "2.3.5 (buildtime=22:12:02.68)";
...
createNode transform -n "pPlane1";
	setAttr ".t" -type "double3" 0.96335753246664879 0 -2.5295483381324591 ;
...
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" 0 5.6671095337030897 0 ;
createNode pointLight -n "pointLightShape1" -p "pointLight1";
	setAttr -k off ".v";
	setAttr ".us" no;
createNode place3dTexture -n "place3dTexture1";
createNode transform -n "pPlane2";
	setAttr ".t" -type "double3" 13.999801341653431 0 0.96581129008448308 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/as_test_envSphere64.xml";
...
createNode polyPlane -n "polyPlane1";
	setAttr ".w" 14.565749932215084;
	setAttr ".h" 15.27624744529113;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
...
createNode bb -n "aa";
createNode BB -n "aac";
	addAttr -ci true -sn "ms" -ln "mass" -dv 1 -at "double";
createNode polyPlane -n "polyPlane2";
	setAttr ".w" 5.6361483066630669;
	setAttr ".h" 6.8788163962958855;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
...
createNode file -n "file2";
	setAttr ".ftn" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_as_simple/envSphere0.jpg";
...
connectAttr "envBall1.oc" "liqGlobalsNodeRenderer_appleseed.mirrorball_map_environment_edf_exitance"
		;
connectAttr "envSphere1.oc" "liqGlobalsNodeRenderer_appleseed.latlong_map_environment_edf_exitance"
		;
connectAttr "place3dTexture1.wim" "envBall1.pm";
...
connectAttr "place3dTexture2.wim" "envSphere1.pm";
connectAttr "file2.oc" "envSphere1.so";
