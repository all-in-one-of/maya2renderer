...
//Name: brdfmix_physicalSS2.ma
//Last modified: Fri, Aug 10, 2012 12:04:20 AM
//Codeset: 936
requires maya "2012";
requires "liquid_2012x32d" "2.3.5 (buildtime=23:12:19.54)";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -16.64217169415398 67.612087344529883 8.9848540500223137 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/brdfmix_physicalSS2162.xml";
...
createNode file -n "file1";
	setAttr ".ftn" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_as_simple/check18.bmp";
createNode place2dTexture -n "place2dTexture1";
createNode file -n "file2";
	setAttr ".ftn" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_as_simple/check19.bmp";
createNode place2dTexture -n "place2dTexture2";
createNode file -n "file21";
	setAttr ".ftn" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_as_simple/check21.bmp";
createNode place2dTexture -n "place2dTexture3";
createNode file -n "file20";
	setAttr ".ftn" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_as_simple/check20.bmp";
...
connectAttr "file20.oc" "liquidSurface2.lambertian_brdf_reflectance_multiplier";
connectAttr "liquidSurface2.oc" "liquidSurface2SG.ss";
connectAttr "pPlaneShape2.iog" "liquidSurface2SG.dsm" -na;
...
connectAttr "file21.oc" "liquidSurface3.lambertian_brdf_reflectance_multiplier";
connectAttr "liquidSurface3.oc" "liquidSurface3SG.ss";
connectAttr "pPlaneShape3.iog" "liquidSurface3SG.dsm" -na;
...
connectAttr "liquidSurface2.bsdf_model" "liquidSurface4.bsdf_mix_bsdf1";
connectAttr "liquidSurface3.bsdf_model" "liquidSurface4.bsdf_mix_bsdf0";
connectAttr "file1.oa" "liquidSurface4.bsdf_mix_weight0";
connectAttr "file2.oa" "liquidSurface4.bsdf_mix_weight1";
