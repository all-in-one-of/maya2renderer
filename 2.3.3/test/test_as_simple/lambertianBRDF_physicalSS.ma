...
//Name: lambertianBRDF_physicalSS.ma
//Last modified: Wed, Aug 08, 2012 11:38:04 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 95.466969578725099 71.600227184043902 95.466969578725156 ;
...
createNode transform -n "pPlane1";
	setAttr ".t" -type "double3" -2.8304971882673886 0 -1.8054900218442107 ;
...
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" 8.4523706498838447 5.8058997326862505 0 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/as_test_shader32711.xml";
...
createNode liquidSurface -n "liquidSurface2";
	...
	setAttr -k on ".lambertian_brdf_reflectance" -type "float3" 0.84090942 0.84090942 
		0.84090942 ;
	setAttr ".edf_model" -type "string" "diffuse_edf";
	setAttr -k on ".diffuse_edf_exitance" -type "float3" 0.015152209 0.015152209 0.015152209 ;
...
// End of lambertianBRDF_physicalSS.ma
