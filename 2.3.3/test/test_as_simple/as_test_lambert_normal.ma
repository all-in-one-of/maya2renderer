...
//Name: as_test_lambert_normal.ma
//Last modified: Thu, Sep 06, 2012 12:21:16 AM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.18928375090485261 8.2885376578937322 5.8322379317479776 ;
	setAttr ".r" -type "double3" -38.13835272960123 3.3999999999993076 1.1948110786458262e-015 ;
...
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" -0.36864447618587803 1.2468047582132593 -4.0602546025561068 ;
...
createNode transform -n "pPlane7";
	setAttr ".t" -type "double3" -0.40433681172459712 0.52989062619417604 -2.2140672407605324 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/as_test_lambert_normal32287.xml";
...
createNode lambert -n "lambert4";
	setAttr ".c" -type "float3" 0.52941179 0.26989621 0.26989621 ;
...
// End of as_test_lambert_normal.ma
