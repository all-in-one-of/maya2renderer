...
//Name: as_test_lambert_alpha_texture.ma
//Last modified: Sun, Sep 09, 2012 01:50:24 AM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -12.768732346530008 6.5622727132360872 -4.1391252880426173 ;
	setAttr ".r" -type "double3" -8.1383527294982816 -101.79999999999947 0 ;
...
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" -3.6058785801643367 3.8823344279159389 -4.97980803419295 ;
...
createNode transform -n "pPlane7";
	setAttr ".t" -type "double3" 0.98842412811281477 0 -2.6878655961942082 ;
createNode mesh -n "pPlaneShape4" -p "pPlane7";
...
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" 0.52880548733365718 5.0397483374046672 -1.5830879395260289 ;
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 4 ".pt";
	setAttr ".pt[1]" -type "float3" 0 -2.0114317 2.8014984 ;
	setAttr ".pt[3]" -type "float3" 0 2.0874534 2.8014984 ;
	setAttr ".pt[5]" -type "float3" 0 2.0874534 -2.8014984 ;
	setAttr ".pt[7]" -type "float3" 0 -2.0114317 -2.8014984 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/as_test_lambert_alpha_texture339.xml";
...
createNode liqGlobalsNodeRenderer -n "liqGlobalsNodeRenderer_appleseed";
	...
	setAttr ".final_sample_filter_type" 1;
...
createNode file -n "file2";
	setAttr ".ftn" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_as_simple/check11.png";
...
createNode polyPlane -n "polyPlane4";
	setAttr ".w" 8.8153429693247869;
	setAttr ".h" 7.6000004135734098;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
createNode polyCube -n "polyCube1";
	setAttr ".w" 2.3624385961237859;
	setAttr ".h" 3.6398884660605275;
	setAttr ".d" 2.6761511189736842;
	setAttr ".cuv" 4;
...
// End of as_test_lambert_alpha_texture.ma
