...
//Name: as_test_lambert_alpha2.ma
//Last modified: Fri, Sep 07, 2012 03:07:30 AM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -5.1628599745758317 3.9803704598007617 -0.58876643874754342 ;
	setAttr ".r" -type "double3" -19.538352729600486 -78.200000000000358 7.7765674515913633e-015 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 4.6181738896992695;
...
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" 0.52880548733365718 1.8199442330302638 -1.5830879395260289 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/as_test_lambert_alpha2231.xml";
...
createNode lambert -n "lambert4";
	...
	setAttr ".it" -type "float3" 0.70803386 0.70803386 0.70803386 ;
...
// End of as_test_lambert_alpha2.ma
