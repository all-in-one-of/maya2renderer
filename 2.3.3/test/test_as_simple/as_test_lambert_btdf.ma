...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 10.053865883879389;
...
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" -1.3857193898083464 1.8199442330302638 -2.8496950160601946 ;
...
createNode polyCube -n "polyCube2";
	setAttr ".w" 2.0891439607726845;
	setAttr ".h" 1.6684455158672844;
	setAttr ".d" 1.3993364550461402;
	setAttr ".cuv" 4;
...
select -ne :lambert1;
	...
	addAttr -ci true -sn "miibl" -ln "miScatterLimit" -dv 1 -min 0 -smx 10 -at "short";
	addAttr -ci true -sn "miibx" -ln "miScatterCache" -at "short";
	setAttr ".tc" 0.017621146515011787;
...
// End of as_test_lambert_btdf.ma
