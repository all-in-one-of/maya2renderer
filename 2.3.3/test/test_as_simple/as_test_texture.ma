...
//Name: as_test_texture.ma
//Last modified: Fri, Nov 16, 2012 11:52:38 PM
//Codeset: 936
requires maya "2012";
requires "liquid_2012x32d" "2.3.5 (buildtime= 1:50:32.62)";
requires "stereoCamera" "10.0";
requires "mayaseed.py" "Unknown";
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 14.098517871792234;
...
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" -0.45494059220900951 0 -2.3318262312174767 ;
	setAttr ".s" -type "double3" 4.0713274225662817 1 1 ;
...
createNode transform -n "pPlane1";
	setAttr ".t" -type "double3" -0.34749034749034546 -9.5161973539299149e-016 -9.4401544401544655 ;
	setAttr ".r" -type "double3" 89.411085285717732 0 0 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/as_test_texture100.xml";
...
createNode ms_renderSettings -n "ms_renderSettings1";
	setAttr ".out_dir" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_as_simple";
createNode file -n "file1";
	setAttr ".ftn" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_as_simple/check11.bmp";
createNode place2dTexture -n "place2dTexture1";
createNode colorProfile -n "colorProfile1";
createNode polyPlane -n "polyPlane1";
	setAttr ".ax" -type "double3" 0 1 2.2204460492503131e-016 ;
	setAttr ".w" 8.9189189189189175;
	setAttr ".h" 8.571428571428573;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
...
connectAttr ":perspShape.nds" "ms_renderSettings1.cam";
