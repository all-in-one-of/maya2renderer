...
//Name: as_test_spotlight.ma
//Last modified: Fri, Nov 16, 2012 11:49:32 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.4313665208851027 18.464027739453325 3.8058517588085232 ;
	setAttr ".r" -type "double3" -43.538352729475996 79.7999999999995 1.7960636674416123e-014 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 15.425616178577014;
...
createNode transform -n "spotLight1";
	setAttr ".t" -type "double3" -5.7247214217578204 7.408709684045931 0.017385130708285068 ;
	setAttr ".r" -type "double3" 0.42658347527224028 0 0 ;
createNode spotLight -n "spotLightShape1" -p "spotLight1";
	setAttr -k off ".v";
	setAttr ".pa" 10;
createNode transform -n "pPlane8";
	setAttr ".t" -type "double3" -4.6985432844802482 6.596916876222684 1.1925177173928474 ;
	setAttr ".r" -type "double3" -47.359711716998454 0 0 ;
createNode mesh -n "pPlaneShape5" -p "pPlane8";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode transform -n "pPlane9";
	setAttr ".t" -type "double3" -4.5034363378339126 6.4282515952038306 -3.700108859988779 ;
	setAttr ".r" -type "double3" 66.690230015519177 0 0 ;
createNode mesh -n "pPlaneShape6" -p "pPlane9";
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/as_test_spotlight130.xml";
...
createNode polyPlane -n "polyPlane5";
	setAttr ".w" 9.618896042191956;
	setAttr ".h" 9.9126898648916644;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
createNode polyPlane -n "polyPlane6";
	setAttr ".w" 9.4721447310952058;
	setAttr ".h" 9.4921792641780129;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
createNode liqGlobalsNodeRenderer -n "liqGlobalsNodeRenderer_appleseed";
	...
	addAttr -ci true -h true -sn "light_intensity_factor" -ln "light_intensity_factor" 
		-dv 30 -at "float";
	setAttr ".constant_environment_edf_exitance" -type "float3" 0 0.4509804 0.37575695 ;
