...
//Name: mib_amb_occlusion.ma
//Last modified: Thu, Aug 02, 2012 01:20:10 AM
//Codeset: 936
requires maya "2012";
requires "Mayatomr" "2012.0m - 3.9.1.36 ";
requires "liquid_2012x32d" "2.3.5 (buildtime= 1:15:23.07)";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.0312425786419879 5.7202720968465446 9.8893143468967395 ;
	setAttr ".r" -type "double3" -28.538352729612836 -12.999999999998774 8.1605408366187336e-016 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/mib_amb_occlusion1008.xml";
	setAttr ".ray" yes;
	setAttr ".ime" 0;
...
createNode mib_amb_occlusion -n "mib_amb_occlusion1";
	setAttr ".S00" 4;
	setAttr ".S01" -type "float3" 1 0.99283332 0 ;
	setAttr ".S02" -type "float3" 1 0.016333334 0 ;
...
createNode liqGlobalsNodeRenderer -n "liqGlobalsNodeRenderer_appleseed";
	...
	setAttr ".final_sample_filter_size" 2;
