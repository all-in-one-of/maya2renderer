...
//Name: occlude2.ma
//Last modified: Wed, Apr 18, 2012 08:12:53 PM
//Codeset: 936
requires maya "2009";
requires "Mayatomr" "10.0.1.8m - 3.7.1.26 ";
requires "liquid_2009x32d" "2.3.5 (buildtime=23:25:55.25)";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.077844949397301105 0.875867995659388 2.3994125272056341 ;
	setAttr ".r" -type "double3" -15.938352729612802 -21.799999999998789 -4.2819106514366653e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 3.2716041559398286;
...
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" 1.758527308822424 0.40275037210174891 0 ;
	setAttr -av ".tx";
	setAttr -av ".ty";
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".unt" yes;
	setAttr ".osg" yes;
	setAttr ".fseq" -type "string" "1-10";
	setAttr ".rdc" -type "string" "prman";
	setAttr ".prv" -type "string" "prman";
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/occlude2.xml";
	setAttr ".ray" yes;
...
createNode animCurveTL -n "pCube1_translateX";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -3.6397592178986202 10 1.758527308822424;
...
createNode mib_amb_occlusion -n "mib_amb_occlusion1";
	setAttr ".S00" 128;
	setAttr ".S01" -type "float3" 0.69994646 0.71899998 0 ;
	setAttr ".S02" -type "float3" 0.0068335533 0 1 ;
	setAttr ".S03" 1;
	setAttr ".S04" 10000;
...
createNode liquidSurface -n "liquidSurface1";
	...
	addAttr -ci true -h true -sn "maxdist" -ln "maxdist" -at "double";
	setAttr ".rms" -type "string" "occlude2";
	setAttr ".rst" -type "string" "surface";
	setAttr ".rml" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_ao2/occlude2.slo";
	setAttr ".rpr" -type "stringArray" 2 "samples" "maxdist"  ;
	setAttr ".rdt" -type "stringArray" 2 "uniform" "uniform"  ;
	setAttr ".rty" -type "stringArray" 2 "float" "float"  ;
	setAttr ".rdf" -type "stringArray" 2 "32.0" "100000.0"  ;
	setAttr ".ras" -type "Int32Array" 2 -1 -1 ;
	setAttr ".rlc" -type "stringArray" 2 "liquidAE_LifFloat( \"samples\", -1, \"float\", \"samples\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"maxdist\", -1, \"float\", \"maxdist\", {\"0\", \"0\"}, \"\", 14 );"  ;
	setAttr ".rmt" -type "stringArray" 1 "surface"  ;
	setAttr ".rio" -type "Int32Array" 2 0 0 ;
	setAttr ".samples" 32;
	setAttr ".maxdist" 100000;
...
connectAttr "mib_amb_occlusion1.S11" ":lambert1.ambc";
// End of occlude2.ma
