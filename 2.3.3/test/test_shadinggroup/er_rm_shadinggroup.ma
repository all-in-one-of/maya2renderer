...
//Name: er_rm_shadinggroup.ma
//Last modified: Tue, Oct 23, 2012 10:38:49 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -n "pPlane3";
	addAttr -ci true -sn "liqShadingGroup_surface" -ln "liqShadingGroup_surface" -dt "string";
	addAttr -ci true -sn "liqShadingGroup_displacement" -ln "liqShadingGroup_displacement" 
		-dt "string";
	addAttr -ci true -sn "liqShadingGroup_shadow" -ln "liqShadingGroup_shadow" -dt "string";
	addAttr -ci true -sn "liqShadingGroup_volume" -ln "liqShadingGroup_volume" -dt "string";
	addAttr -ci true -sn "liqShadingGroup_environment" -ln "liqShadingGroup_environment" 
		-dt "string";
	addAttr -ci true -sn "liqShadingGroup_photon" -ln "liqShadingGroup_photon" -dt "string";
...
createNode transform -n "pPlane4";
	setAttr ".t" -type "double3" 12.616778628147223 0 -7.3607690585709253 ;
...
createNode polyPlane -n "polyPlane4";
	setAttr ".w" 15.197517268693304;
	setAttr ".h" 13.424445750665054;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
select -ne :time1;
...
connectAttr "lambert3.oc" "lambert2SG.ds";
connectAttr "blinn1.oc" "lambert2SG.liqShadowShader";
connectAttr "blinn2.oc" "lambert2SG.liqEnvironmentShader";
connectAttr ":lambert1.oc" "lambert2SG.liqPhotonShader";
connectAttr ":lambert1.oc" "lambert2SG.vs";
...
connectAttr "blinn1.oc" ":initialShadingGroup.ds";
connectAttr "lambert2.oc" ":initialShadingGroup.liqShadowShader";
connectAttr "blinn2.oc" ":initialShadingGroup.liqEnvironmentShader";
connectAttr "lambert3.oc" ":initialShadingGroup.liqPhotonShader";
connectAttr "lambert3.oc" ":initialShadingGroup.vs";
