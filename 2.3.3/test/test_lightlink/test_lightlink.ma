...
//Name: test_lightlink.ma
//Last modified: Tue, Sep 25, 2012 11:08:38 PM
//Codeset: 936
requires maya "2012";
requires "liquid_2012x32d" "2.3.5 (buildtime=22:41:34.07)";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.0565815638038454 17.764087014925192 0.039788508072556683 ;
	setAttr ".r" -type "double3" -78.938352729318765 90.599999999984462 3.0533324942049761e-013 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 17.8074918523596;
...
createNode transform -n "pPlane1";
	setAttr ".t" -type "double3" -1.9690948618891413 0 1.8227243308784691 ;
	setAttr ".s" -type "double3" 0.15796005784015021 1 1 ;
...
createNode transform -n "pPlane2";
	setAttr ".t" -type "double3" -1.986526196254661 0 -1.6910502354784995 ;
	setAttr ".s" -type "double3" 0.15796005784015021 1 1 ;
...
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" 0.035926236136890832 0.60728040749258261 -0.0048663665193928729 ;
createNode pointLight -n "pointLightShape1" -p "pointLight1";
	setAttr -k off ".v";
	setAttr ".in" 0.5;
	setAttr ".us" no;
createNode transform -n "pointLight2";
	setAttr ".t" -type "double3" 0.06818890712970993 0.62495062131156409 2.6000576192158968 ;
createNode pointLight -n "pointLightShape2" -p "pointLight2";
	setAttr -k off ".v";
	setAttr ".in" 0.5;
createNode transform -n "pPlane3";
	setAttr ".t" -type "double3" 1.3020136191766314 0 1.860283015904161 ;
...
createNode transform -n "pPlane4";
	setAttr ".t" -type "double3" 1.3552221543680885 0 -1.7159694946081434 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_lightlink1148.xml";
...
createNode polyPlane -n "polyPlane1";
	setAttr ".w" 23.825088140319099;
	setAttr ".h" 3.518495775348903;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
createNode polyPlane -n "polyPlane2";
	setAttr ".w" 23.862837803124233;
	setAttr ".h" 3.2392111445603327;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
createNode polyPlane -n "polyPlane3";
	setAttr ".w" 2.5951097616553138;
	setAttr ".h" 3.5470505174656246;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
createNode polyPlane -n "polyPlane4";
	setAttr ".w" 2.5733667751096938;
	setAttr ".h" 3.2494638067130728;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
...
relationship "ignore" ":lightLinker1" "pPlaneShape3.message" "pointLightShape1.message";
relationship "ignore" ":lightLinker1" "pPlaneShape2.message" "pointLightShape2.message";
relationship "ignore" ":lightLinker1" "pPlaneShape4.message" "pointLightShape2.message";
