...
//Last modified: Thu, Jun 21, 2012 11:11:16 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -23.471743425144073 18.142706739575051 3.1992966331660568 ;
	setAttr ".r" -type "double3" -37.5383527298088 285.39999999995251 1.1976958812221965e-014 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 26.884570994896951;
...
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" 0.069148479719545186 1.3213682867908494 -2.2597171043819069 ;
...
createNode transform -n "directionalLight3";
	setAttr ".t" -type "double3" -2.9149797570850211 6.0837135579922661 -5.3248261364879736 ;
	setAttr ".r" -type "double3" -45.63431174683285 -115.17524652161009 0 ;
createNode directionalLight -n "directionalLightShape1" -p "directionalLight3";
	setAttr -k off ".v";
...
connectAttr "liquidSurface3.msg" "materialInfo2.m";
connectAttr "liquidSurface3.msg" "materialInfo2.t" -na;
