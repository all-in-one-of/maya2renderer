...
//Name: test_multiple_shapes_simple.ma
//Last modified: Tue, Sep 25, 2012 10:59:59 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -9.4296788439829182 25.34013891043498 7.5276137246609061 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 28.066108591831817;
...
createNode transform -n "pCube2" -p "group1";
	setAttr ".t" -type "double3" -5.2050518852018079 0.54638698923793261 -0.86194801704433011 ;
...
createNode transform -n "pPlane1" -p "group1";
	setAttr ".t" -type "double3" -2.1186905409258734 -1.233248886482975e-016 2.6884791629964067 ;
	setAttr ".r" -type "double3" 0 16.138337065790484 0 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_multiple_shapes_simple446.xml";
...
createNode polyPlane -n "polyPlane1";
	...
	setAttr ".w" 1.3885148064049508;
	setAttr ".h" 1.110811845123961;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
...
// End of test_multiple_shapes_simple.ma
