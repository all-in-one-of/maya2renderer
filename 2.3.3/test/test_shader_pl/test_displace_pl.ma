...
//Name: test_displace_pl.ma
//Last modified: Fri, Feb 24, 2012 12:12:35 AM
//Codeset: 936
requires maya "2009";
requires "liquid_2009x32d" "2.3.5 (buildtime=21:49:53.64)";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.7660306108791763 8.1608734920410981 22.640818740261349 ;
	setAttr ".r" -type "double3" -17.738352729603303 -0.99999999999993483 -7.4555605526641063e-017 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".ddin[0]" -type "string" "$SCN_$CAM_$F.bmp";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_displace_pl.xml";
...
createNode liquidDisplacement -n "liquidDisplacement1";
	...
	setAttr ".rms" -type "string" "simple_displace";
	setAttr ".rst" -type "string" "displace";
	setAttr ".rml" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_shader_pl/simple_displace.dll";
	...
	setAttr ".rlc" -type "stringArray" 1 "liquidAE_LifFloat( \"disp_dist\", -1, \"float\", \"disp_dist\", {\"0\", \"0\"}, \"\", 14 );"  ;
	setAttr ".rmt" -type "stringArray" 0  ;
	setAttr ".rio" -type "Int32Array" 1 0 ;
	setAttr ".disp_dist" 1;
createNode liquidSurface -n "liquidSurface25";
	...
	setAttr ".rml" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_shader_pl/plastic.dll";
	...
	setAttr -k on ".Cs" -type "double3" 1 1 1 ;
	setAttr -k on ".Kd" -type "double3" 1 1 1 ;
	setAttr ".Ks" 0.5;
	setAttr ".roughness" 0.1;
	setAttr -k on ".specularcolor" -type "float3" 1 1 1 ;
createNode liquidSurface -n "liquidSurface26";
	setAttr ".rms" -type "string" "opaque";
	setAttr ".rst" -type "string" "shadow";
	setAttr ".rml" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_shader_pl/opaque.dll";
...
connectAttr "liquidSurface24SG.msg" "lightLinker1.lnk[17].olnk";
connectAttr ":defaultLightSet.msg" "lightLinker1.lnk[20].llnk";
connectAttr "liquidSurface26SG.msg" "lightLinker1.lnk[20].olnk";
...
connectAttr "liquidSurface24SG.msg" "lightLinker1.slnk[17].solk";
connectAttr ":defaultLightSet.msg" "lightLinker1.slnk[20].sllk";
connectAttr "liquidSurface26SG.msg" "lightLinker1.slnk[20].solk";
...
connectAttr "liquidSurface25.oc" "liquidSurface24SG.ss";
connectAttr "pPlaneShape11.iog" "liquidSurface24SG.dsm" -na;
connectAttr "liquidDisplacement1.d" "liquidSurface24SG.ds";
connectAttr "liquidSurface26.oc" "liquidSurface24SG.liqShadowShader";
connectAttr "liquidSurface24SG.msg" "materialInfo16.sg";
connectAttr "liquidSurface25.msg" "materialInfo16.m";
connectAttr "liquidSurface25.msg" "materialInfo16.t" -na;
connectAttr "liquidSurface26.oc" "liquidSurface26SG.ss";
connectAttr "liquidSurface26SG.msg" "materialInfo17.sg";
connectAttr "liquidSurface26.msg" "materialInfo17.m";
connectAttr "liquidSurface26.msg" "materialInfo17.t" -na;
connectAttr "lambert2SG.pa" ":renderPartition.st" -na;
connectAttr "liquidSurface24SG.pa" ":renderPartition.st" -na;
connectAttr "liquidSurface26SG.pa" ":renderPartition.st" -na;
connectAttr "lambert2.msg" ":defaultShaderList1.s" -na;
connectAttr "liquidDisplacement1.msg" ":defaultShaderList1.s" -na;
connectAttr "liquidSurface25.msg" ":defaultShaderList1.s" -na;
connectAttr "liquidSurface26.msg" ":defaultShaderList1.s" -na;
