...
//Name: test_type.ma
//Last modified: Wed, Feb 01, 2012 11:01:39 AM
//Codeset: 936
requires maya "2009";
requires "liquid_2009x32d" "2.3.5 (buildtime=22:10:51.23)";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.26295828094956158 46.910526067848707 7.8605635825936231 ;
	setAttr ".r" -type "double3" -75.338352729603372 2.2000000000000695 -1.9893129658559691e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 44.852222643258607;
...
createNode transform -n "pPlane9";
	setAttr ".t" -type "double3" 8.5567515949490591 0 -0.8600499629303946 ;
...
createNode liquidSurface -n "liquidSurface17";
	...
	setAttr ".rdf" -type "stringArray" 8 "7.0" "test stringATT" "1.0000001.0000001.000000" "2.0000002.0000002.000000" "3.0000003.0000003.000000" "4.0000004.0000004.000000" "0.000000:0.000000:0.000000:0.000000; 0.000000:0.000000:0.000000:0.000000; 0.000000:0.000000:0.000000:0.000000; 0.000000:0.000000:0.000000:0.000000" "0.000000:1.000000:2.000000:3.000000; 4.000000:5.000000:6.000000:7.000000; 8.000000:9.000000:10.000000:11.000000; 12.000000:13.000000:14.000000:15.000000"  ;
	setAttr ".ras" -type "Int32Array" 8 -1 -1 -1 -1 -1 -1
		 -1 -1 ;
	setAttr ".rlc" -type "stringArray" 8 "liquidAE_LifFloat( \"frequency\", -1, \"float\", \"frequency\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifString( \"s0\", -1, \"string\", \"s0\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifColor( \"c0\", -1, \"color\", \"c0\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifVector( \"p0\", -1, \"point\", \"p0\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifVector( \"v0\", -1, \"vector\", \"v0\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifVector( \"n0\", -1, \"normal\", \"n0\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifMatrix( \"m0\", -1, \"matrix\", \"m0\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifMatrix( \"m1\", -1, \"matrix\", \"m1\", {\"0\", \"0\"}, \"\", 14 );"  ;
	setAttr ".rio" -type "Int32Array" 8 0 0 0 0 0 0
		 0 0 ;
	setAttr ".frequency" 11.942099999999998;
	setAttr ".s0" -type "string" "test stringATT";
	setAttr -k on ".c0" -type "float3" 1 1 1 ;
	setAttr -k on ".p0" -type "double3" 2 2 2 ;
	setAttr -k on ".v0" -type "double3" 3 3 3 ;
	setAttr -k on ".n0" -type "double3" 4 4 4 ;
...
createNode polyPlane -n "polyPlane9";
	setAttr ".w" 9.8339585935388047;
	setAttr ".h" 7.6379650494191926;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
...
connectAttr "liquidSurface11SG.msg" "lightLinker1.lnk[3].olnk";
connectAttr ":defaultLightSet.msg" "lightLinker1.lnk[4].llnk";
connectAttr "liquidSurface12SG.msg" "lightLinker1.lnk[4].olnk";
connectAttr ":defaultLightSet.msg" "lightLinker1.lnk[5].llnk";
connectAttr "liquidSurface13SG.msg" "lightLinker1.lnk[5].olnk";
connectAttr ":defaultLightSet.msg" "lightLinker1.lnk[6].llnk";
connectAttr "liquidSurface14SG.msg" "lightLinker1.lnk[6].olnk";
...
connectAttr "liquidSurface17SG.msg" "lightLinker1.lnk[10].olnk";
connectAttr ":defaultLightSet.msg" "lightLinker1.lnk[11].llnk";
connectAttr "liquidSurface18SG.msg" "lightLinker1.lnk[11].olnk";
...
connectAttr "liquidSurface11SG.msg" "lightLinker1.slnk[3].solk";
connectAttr ":defaultLightSet.msg" "lightLinker1.slnk[4].sllk";
connectAttr "liquidSurface12SG.msg" "lightLinker1.slnk[4].solk";
connectAttr ":defaultLightSet.msg" "lightLinker1.slnk[5].sllk";
connectAttr "liquidSurface13SG.msg" "lightLinker1.slnk[5].solk";
connectAttr ":defaultLightSet.msg" "lightLinker1.slnk[6].sllk";
connectAttr "liquidSurface14SG.msg" "lightLinker1.slnk[6].solk";
...
connectAttr "liquidSurface17SG.msg" "lightLinker1.slnk[10].solk";
connectAttr ":defaultLightSet.msg" "lightLinker1.slnk[11].sllk";
connectAttr "liquidSurface18SG.msg" "lightLinker1.slnk[11].solk";
...
connectAttr "pPlaneShape17.msg" "lightLinker1.ign[1].oign";
...
connectAttr "pPlaneShape11.iog" "liquidSurface17SG.dsm" -na;
connectAttr "liquidSurface17SG.msg" "materialInfo9.sg";
connectAttr "liquidSurface17.msg" "materialInfo9.m";
connectAttr "liquidSurface17.msg" "materialInfo9.t" -na;
connectAttr "polyPlane9.out" "polyTriangulate3.ip";
connectAttr "liquidSurface18.oc" "liquidSurface18SG.ss";
connectAttr "pPlaneShape18.iog" "liquidSurface18SG.dsm" -na;
connectAttr "liquidSurface18SG.msg" "materialInfo10.sg";
connectAttr "liquidSurface18.msg" "materialInfo10.m";
connectAttr "liquidSurface18.msg" "materialInfo10.t" -na;
