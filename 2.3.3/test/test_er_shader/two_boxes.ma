...
//Name: two_boxes.ma
//Last modified: Wed, Jan 11, 2012 09:12:45 PM
//Codeset: 936
requires maya "2009";
requires "liquid_2009x32d" "2.3.5 (buildtime=20:56:24.31)";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.87687510747825015 -0.1638974324011393 35.879459695394061 ;
	setAttr ".r" -type "double3" 0.26164727039402014 1.4000000000000157 3.883672354780334e-019 ;
...
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" -3.2215029420147694 3.8836138701979284 7 ;
...
createNode transform -n "pointLight2";
	setAttr ".t" -type "double3" 3.9610496430108419 0 7.9383842744079836 ;
createNode pointLight -n "pointLightShape2" -p "pointLight2";
	setAttr -k off ".v";
createNode transform -n "pCube2";
	setAttr ".t" -type "double3" 4.1176954783858086 4.4807518740855228 -0.30922518012978273 ;
	setAttr ".s" -type "double3" 5.5164207966526293 1 1 ;
...
createNode script -n "uiConfigurationScriptNode";
	setAttr ".b" -type "string" (
		...
		+ "                -textureDisplay \"modulate\" \n                -textureMaxSize 8192\n                -fogging 0\n                -fogSource \"fragment\" \n                -fogMode \"linear\" \n                -fogStart 0\n                -fogEnd 100\n                -fogDensity 0.1\n                -fogColor 0.5 0.5 0.5 1 \n                -maxConstantTransparency 1\n                -colorResolution 4 4 \n                -bumpResolution 4 4 \n                -textureCompression 0\n                -transparencyAlgorithm \"frontAndBackCull\" \n                -transpInShadows 0\n                -cullingOverride \"none\" \n                -lowQualityLighting 0\n                -maximumNumHardwareLights 0\n                -occlusionCulling 0\n                -shadingModel 0\n                -useBaseRenderer 0\n                -useReducedRenderer 0\n                -smallObjectCulling 0\n                -smallObjectThreshold -1 \n                -interactiveDisableShadows 0\n                -interactiveBackFaceCull 0\n                -sortTransparent 1\n"
		+ "                -nurbsCurves 1\n                -nurbsSurfaces 1\n                -polymeshes 1\n                -subdivSurfaces 1\n                -planes 1\n                -lights 1\n                -cameras 1\n                -controlVertices 1\n                -hulls 1\n                -grid 1\n                -joints 1\n                -ikHandles 1\n                -deformers 1\n                -dynamics 1\n                -fluids 1\n                -hairSystems 1\n                -follicles 1\n                -nCloths 1\n                -nParticles 1\n                -nRigids 1\n                -dynamicConstraints 1\n                -locators 1\n                -manipulators 1\n                -dimensions 1\n                -handles 1\n                -pivots 1\n                -textures 1\n                -strokes 1\n                -shadows 0\n                -displayMode \"centerEye\" \n                -viewColor 0 0 0 1 \n                $editorName;\nstereoCameraView -e -viewSelected 0 $editorName;\n\t\tif (!$useSceneConfig) {\n\t\t\tpanel -e -l $label $panelName;\n"
		+ "\t\t}\n\t}\n\n\n\tif ($useSceneConfig) {\n        string $configName = `getPanel -cwl (localizedPanelLabel(\"Current Layout\"))`;\n        if (\"\" != $configName) {\n\t\t\tpanelConfiguration -edit -label (localizedPanelLabel(\"Current Layout\")) \n\t\t\t\t-defaultImage \"\"\n\t\t\t\t-image \"\"\n\t\t\t\t-sc false\n\t\t\t\t-configString \"global string $gMainPane; paneLayout -e -cn \\\"quad\\\" -ps 1 49 60 -ps 2 51 60 -ps 3 51 40 -ps 4 49 40 $gMainPane;\"\n\t\t\t\t-removeAllPanels\n\t\t\t\t-ap false\n\t\t\t\t\t(localizedPanelLabel(\"Top View\")) \n\t\t\t\t\t\"modelPanel\"\n"
...
connectAttr "lambert2.assignedObjects" "pCubeShape1.liquidSurfaceShaderNode";
...
connectAttr "lambert3SG.msg" "lightLinker1.slnk[2].solk";
connectAttr "pointLightShape2.msg" "lightLinker1.ign[0].lign";
connectAttr "pCubeShape1.msg" "lightLinker1.ign[0].oign";
connectAttr "pointLightShape1.msg" "lightLinker1.ign[1].lign";
connectAttr "pCubeShape2.msg" "lightLinker1.ign[1].oign";
