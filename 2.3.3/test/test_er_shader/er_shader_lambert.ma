...
//Last modified: Sat, Jan 21, 2012 12:13:41 PM
//Codeset: 936
requires maya "2009";
requires "liquid_2009x32d" "2.3.5 (buildtime=12:12:31.48)";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 11.389436694756506 33.171833453265876 27.908962666588224 ;
	setAttr ".r" -type "double3" -47.738352729602639 22.20000000000007 0 ;
...
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" -12.379008020606978 0 7 ;
