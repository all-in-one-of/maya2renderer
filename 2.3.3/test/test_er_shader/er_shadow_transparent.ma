...
//Name: er_shadow_transparent.ma
//Last modified: Wed, Feb 15, 2012 12:14:54 AM
//Codeset: 936
requires maya "2009";
requires "liquid_2009x32d" "2.3.5 (buildtime= 0:04:51.84)";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.6345576372893715 7.211119518278565 -1.1073604861430932 ;
	setAttr ".r" -type "double3" -53.138352729603469 96.20000000000347 -2.5444437451708134e-014 ;
...
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" 0.5183968663997035 0.19459887929879671 -0.65379975449393191 ;
createNode pointLight -n "pointLightShape1" -p "pointLight1";
	setAttr -k off ".v";
	setAttr ".us" no;
createNode transform -n "pPlane2";
	setAttr ".t" -type "double3" -0.20578266005533186 0 0.045356522678271394 ;
...
createNode transform -n "pCube2";
	setAttr ".t" -type "double3" -0.73734296749186656 -0.18265522894441 -0.43350023996556009 ;
...
createNode transform -n "pPlane3";
	setAttr ".t" -type "double3" 0.038304910811389981 -0.36963657565553104 -0.80855565579213118 ;
...
createNode transform -n "pPlane4";
	setAttr ".t" -type "double3" 0.56457844082804365 -0.51789543677062455 -1.3274091128737417 ;
...
createNode liquidSurface -n "liquidSurface1";
	addAttr -ci true -h true -sn "myopacity" -ln "myopacity" -at "double";
	setAttr ".rms" -type "string" "transparent";
	setAttr ".rst" -type "string" "shadow";
	setAttr ".rml" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_er_shader/maya_transparent.dll";
	setAttr ".rpr" -type "stringArray" 1 "myopacity"  ;
	...
	setAttr ".rlc" -type "stringArray" 1 "liquidAE_LifFloat( \"myopacity\", -1, \"float\", \"myopacity\", {\"0\", \"0\"}, \"\", 14 );"  ;
...
connectAttr "liquidSurface1.oc" "lambert2SG.liqShadowShader";
...
// End of er_shadow_transparent.ma
