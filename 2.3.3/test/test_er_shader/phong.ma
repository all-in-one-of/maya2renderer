...
//Name: phong.ma
//Last modified: Thu, Mar 07, 2013 11:50:02 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.6408294363819076 22.636828027162917 14.103079702025534 ;
	setAttr ".r" -type "double3" -56.138352729603682 21.800000000000495 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 27.260627229454919;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/phong3026.xml";
...
createNode phong -n "phong1";
	...
	setAttr ".it" -type "float3" 0.44715038 0.44715038 0.44715038 ;
