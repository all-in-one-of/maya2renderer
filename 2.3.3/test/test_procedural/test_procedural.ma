...
//Last modified: Sat, Mar 16, 2013 05:48:04 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.4125101458716949 24.474523671063427 24.56024763910164 ;
	setAttr ".r" -type "double3" -33.60000000000079 1.1999999999999964 2.4853534239700986e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 59.747803603972912;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_procedural3826.xml";
...
createNode liquidShader -n "liquidShader1";
	...
	setAttr ".rml" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_procedural/simple_procedural.dll";
