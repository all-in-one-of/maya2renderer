...
//Name: test_pfxHair_onehair.ma
//Last modified: Tue, Oct 30, 2012 10:41:08 PM
//Codeset: 936
requires maya "2012";
requires "liquid_2012x32d" "2.3.5 (buildtime=22:39:21.01)";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.4133148069991071 0.78851847141503784 -3.0582887945435617 ;
	setAttr ".r" -type "double3" -7.538352729638059 158.19999999997327 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 4.929224976600004;
...
createNode transform -n "pPlane4";
	setAttr ".t" -type "double3" -1.4535336578588325 0 4.9347396292380754 ;
	setAttr ".r" -type "double3" -90.194042784248623 0 0 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_pfxHair_onehair.xml";
...
createNode polyPlane -n "polyPlane4";
	setAttr ".w" 2.8764308315208931;
	setAttr ".h" 5.8366254995425777;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
...
// End of test_pfxHair_onehair.ma
