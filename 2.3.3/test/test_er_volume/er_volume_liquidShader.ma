...
//Name: er_volume_liquidShader.ma
//Last modified: Mon, Mar 18, 2013 11:12:40 AM
//Codeset: 936
requires maya "2012";
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/er_volume136.xml";
...
createNode liquidVolume -n "liquidVolume1";
	...
	addAttr -ci true -uac -h true -sn "vol_color" -ln "vol_color" -at "float3" -nc 3;
...
createNode liquidShader -n "liquidShader2";
	...
	setAttr ".rio" -type "Int32Array" 7 0 0 0 0 0 0
		 0 ;
	setAttr ".rma" -type "stringArray" 7 "" "" "" "" "" "" ""  ;
	setAttr ".vol_color" -type "float3" 0.89999998 0.94999999 1 ;
...
// End of er_volume_liquidShader.ma
