...
//Name: test_subdiv.ma
//Last modified: Sun, Sep 23, 2012 10:58:08 AM
//Codeset: 936
requires maya "2012";
requires "liquid_2012x32d" "2.3.5 (buildtime=15:23:38.75)";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.0375231089806833 7.84478103205692 7.6767243610977181 ;
	setAttr ".r" -type "double3" -38.738352729603925 -2.599999999999735 1.9898951340790287e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 11.091676491740788;
...
createNode transform -n "pSphere1";
	setAttr ".t" -type "double3" -4.9582572299891101 0 -0.024725265013345599 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_subdiv32738.xml";
...
connectAttr "polyNormal4.out" "pSphereShape1.i";
