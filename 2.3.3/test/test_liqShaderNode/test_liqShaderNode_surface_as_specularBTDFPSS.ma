...
//Last modified: Sat, Nov 17, 2012 03:35:27 PM
//Codeset: 936
requires maya "2012";
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_liqShaderNode_surface_as_specularBTDFPSS100.xml";
...
createNode liqGlobalsNodeRenderer -n "liqGlobalsNodeRenderer_appleseed";
	...
	addAttr -ci true -h true -sn "export_mesh_normals" -ln "export_mesh_normals" -min 
		0 -max 1 -at "bool";
	setAttr ".constant_environment_edf_exitance" -type "float3" 0.62749678 0.96450752 
		1 ;
...
createNode liquidShader -n "liquidShader13";
	...
	addAttr -ci true -uac -h true -sn "transmittance" -ln "transmittance" -at "float3" 
		-nc 3;
	addAttr -ci true -h true -sn "transmittanceR" -ln "transmittanceR" -at "float" -p "transmittance";
	addAttr -ci true -h true -sn "transmittanceG" -ln "transmittanceG" -at "float" -p "transmittance";
	addAttr -ci true -h true -sn "transmittanceB" -ln "transmittanceB" -at "float" -p "transmittance";
	addAttr -ci true -h true -sn "rmanParamLifCmdId" -ln "rmanParamLifCmdId" -dt "Int32Array";
	addAttr -ci true -h true -sn "rmanGroups" -ln "rmanGroups" -dt "stringArray";
	addAttr -ci true -h true -sn "rmanGroupLifCmdId" -ln "rmanGroupLifCmdId" -dt "Int32Array";
	addAttr -ci true -sn "rmanLifCtrls" -ln "rmanLifCtrls" -dt "stringArray";
	...
	setAttr ".ras" -type "Int32Array" 6 -1 -1 -1 -1 -1 -1 ;
	setAttr ".rlc" -type "stringArray" 11 "liquidAE_LifGrp( \"Reflectance\", 14 );" "liquidAE_LifParameter( \"reflectance\", \"-1\", \"color\", \"color\", \"Reflectance\", {\"\"}, \"reflectance\\nrequired\", 14 );" "liquidAE_LifParameter( \"reflectance_multiplier\", \"-1\", \"float\", \"float\", \"Multiplier\", {\"\"}, \"reflectance_multiplier\\noptional\", 14 );" "liquidAE_LifGrp( \"end\", 14 );" "liquidAE_LifGrp( \"Transmittance\", 14 );" "liquidAE_LifParameter( \"transmittance\", \"-1\", \"color\", \"color\", \"Transmittance\", {\"\"}, \"transmittance\\nrequired\", 14 );" "liquidAE_LifParameter( \"transmittance_multiplier\", \"-1\", \"float\", \"float\", \"Multiplier\", {\"\"}, \"transmittance_multiplier\\nrequired\", 14 );" "liquidAE_LifGrp( \"end\", 14 );" "liquidAE_LifGrp( \"Index of Refraction\", 14 );" "liquidAE_LifParameter( \"from_ior\", \"-1\", \"float\", \"float\", \"From\", {\"\"}, \"from_ior\\nrequired\", 14 );" "liquidAE_LifParameter( \"to_ior\", \"-1\", \"float\", \"float\", \"To\", {\"\"}, \"to_ior\\nrequired\", 14 );"  ;
	setAttr ".rmt" -type "stringArray" 0  ;
	setAttr ".rio" -type "Int32Array" 6 0 0 0 0 0 0 ;
	setAttr ".rma" -type "stringArray" 6 "" "" "" "" "" ""  ;
	...
	setAttr ".from_ior" 1;
	setAttr ".to_ior" 1.5;
	setAttr ".reflectance" -type "float3" 0.63050199 0.85906768 0 ;
	setAttr ".transmittance" -type "float3" 0.16778821 0.16778821 0.16778821 ;
	setAttr ".rmanParamLifCmdId" -type "Int32Array" 6 1 2 5 6
		 9 10 ;
	setAttr ".rmanGroups" -type "stringArray" 0  ;
	setAttr ".rmanGroupLifCmdId" -type "Int32Array" 0 ;
