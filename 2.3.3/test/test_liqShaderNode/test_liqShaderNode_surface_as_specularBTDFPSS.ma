...
//Last modified: Wed, Aug 29, 2012 08:46:14 PM
//Codeset: 936
requires maya "2012";
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_liqShaderNode_surface_as_specularBTDFPSS273.xml";
...
createNode liquidShader -n "liquidShader13";
	...
	setAttr ".ras" -type "Int32Array" 6 -1 -1 -1 -1 -1 -1 ;
	setAttr ".rlc" -type "stringArray" 6 "liquidAE_LifColor( \"reflectance\", -1, \"color\", \"reflectance\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"reflectance_multiplier\", -1, \"float\", \"reflectance_multiplier\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifColor( \"transmittance\", -1, \"color\", \"transmittance\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"transmittance_multiplier\", -1, \"float\", \"transmittance_multiplier\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"from_ior\", -1, \"float\", \"from_ior\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"to_ior\", -1, \"float\", \"to_ior\", {\"0\", \"0\"}, \"\", 14 );"  ;
	setAttr ".rmt" -type "stringArray" 0  ;
	setAttr ".rio" -type "Int32Array" 6 0 0 0 0 0 0 ;
