...
//Name: test_liqShaderNode_surface_as_lambertCSS.ma
//Last modified: Sat, Nov 17, 2012 03:21:44 PM
//Codeset: 936
requires maya "2012";
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_liqShaderNode_surface_as_lambertCSS691.xml";
...
createNode liqGlobalsNodeRenderer -n "liqGlobalsNodeRenderer_appleseed";
	...
	addAttr -ci true -uac -h true -sn "constant_exitance" -ln "constant_exitance" -at "float3" 
		-nc 3;
	addAttr -ci true -sn "constant_exitanceR" -ln "constant_exitanceR" -at "float" -p "constant_exitance";
	addAttr -ci true -sn "constant_exitanceG" -ln "constant_exitanceG" -at "float" -p "constant_exitance";
	addAttr -ci true -sn "constant_exitanceB" -ln "constant_exitanceB" -at "float" -p "constant_exitance";
	addAttr -ci true -uac -h true -sn "gradient_horizon_exitance" -ln "gradient_horizon_exitance" 
		-at "float3" -nc 3;
	addAttr -ci true -sn "gradient_horizon_exitanceR" -ln "gradient_horizon_exitanceR" 
		-at "float" -p "gradient_horizon_exitance";
	addAttr -ci true -sn "gradient_horizon_exitanceG" -ln "gradient_horizon_exitanceG" 
		-at "float" -p "gradient_horizon_exitance";
	addAttr -ci true -sn "gradient_horizon_exitanceB" -ln "gradient_horizon_exitanceB" 
		-at "float" -p "gradient_horizon_exitance";
	addAttr -ci true -uac -h true -sn "gradient_zenith_exitance" -ln "gradient_zenith_exitance" 
		-at "float3" -nc 3;
	addAttr -ci true -sn "gradient_zenith_exitanceR" -ln "gradient_zenith_exitanceR" 
		-at "float" -p "gradient_zenith_exitance";
	addAttr -ci true -sn "gradient_zenith_exitanceG" -ln "gradient_zenith_exitanceG" 
		-at "float" -p "gradient_zenith_exitance";
	addAttr -ci true -sn "gradient_zenith_exitanceB" -ln "gradient_zenith_exitanceB" 
		-at "float" -p "gradient_zenith_exitance";
	addAttr -ci true -uac -h true -sn "latitude_longitude_exitance" -ln "latitude_longitude_exitance" 
		-at "float3" -nc 3;
	addAttr -ci true -sn "latitude_longitude_exitanceR" -ln "latitude_longitude_exitanceR" 
		-at "float" -p "latitude_longitude_exitance";
	addAttr -ci true -sn "latitude_longitude_exitanceG" -ln "latitude_longitude_exitanceG" 
		-at "float" -p "latitude_longitude_exitance";
	addAttr -ci true -sn "latitude_longitude_exitanceB" -ln "latitude_longitude_exitanceB" 
		-at "float" -p "latitude_longitude_exitance";
	addAttr -ci true -uac -h true -sn "mirror_ball_exitance" -ln "mirror_ball_exitance" 
		-at "float3" -nc 3;
	addAttr -ci true -sn "mirror_ball_exitanceR" -ln "mirror_ball_exitanceR" -at "float" 
		-p "mirror_ball_exitance";
	addAttr -ci true -sn "mirror_ball_exitanceG" -ln "mirror_ball_exitanceG" -at "float" 
		-p "mirror_ball_exitance";
	addAttr -ci true -sn "mirror_ball_exitanceB" -ln "mirror_ball_exitanceB" -at "float" 
		-p "mirror_ball_exitance";
	...
	setAttr ".constant_environment_edf_exitance" -type "float3" 0.35294119 0.66666669 
		0.66666669 ;
...
createNode liquidShader -n "liquidShader2";
	...
	addAttr -ci true -uac -h true -sn "color" -ln "color" -at "float3" -nc 3;
	addAttr -ci true -h true -sn "colorR" -ln "colorR" -at "float" -p "color";
	addAttr -ci true -h true -sn "colorG" -ln "colorG" -at "float" -p "color";
	addAttr -ci true -h true -sn "colorB" -ln "colorB" -at "float" -p "color";
	...
	setAttr ".rms" -type "string" "constant_surface_shader0";
	setAttr ".rst" -type "string" "constant_surface_shader";
	setAttr ".rml" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_as_simple/ConstantSurfaceShader.dll";
	setAttr ".rpr" -type "stringArray" 3 "color" "color_multiplier" "alpha_multiplier"  ;
	setAttr ".rdt" -type "stringArray" 3 "uniform" "uniform" "uniform"  ;
	setAttr ".rty" -type "stringArray" 3 "color" "float" "float"  ;
	setAttr ".rdf" -type "stringArray" 3 "1.01.01.0" "1.0" "1.0"  ;
	setAttr ".ras" -type "Int32Array" 3 -1 -1 -1 ;
	setAttr ".rlc" -type "stringArray" 3 "liquidAE_LifParameter( \"color\", \"-1\", \"color\", \"color\", \"Color\", {\"\"}, \"Required parameter\", 14 );" "liquidAE_LifParameter( \"color_multiplier\", \"-1\", \"float\", \"float\", \"Color Multiplier\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"alpha_multiplier\", \"-1\", \"float\", \"slider\", \"Alpha Multiplier\", {\"\"}, \"\", 14 );"  ;
	...
	setAttr -k on ".lambertian_brdf_reflectance" -type "float3" 1 1 1 ;
	setAttr ".edf_model" -type "string" "diffuse_edf";
	setAttr -k on ".diffuse_edf_exitance" -type "float3" 1 1 1 ;
...
connectAttr "liquidShader4.oc" "liquidShader2SG.liqBRDF";
...
// End of test_liqShaderNode_surface_as_lambertCSS.ma
