...
//Last modified: Sat, Sep 01, 2012 08:58:41 PM
//Codeset: 936
requires maya "2012";
...
createNode liquidShader -n "liquidShader2";
	...
	addAttr -ci true -uac -h true -k true -sn "color" -ln "color" -at "float3" -nc 3;
	addAttr -ci true -h true -k true -sn "colora" -ln "colora" -at "float" -p "color";
	addAttr -ci true -h true -k true -sn "colorb" -ln "colorb" -at "float" -p "color";
	addAttr -ci true -h true -k true -sn "colorc" -ln "colorc" -at "float" -p "color";
	...
	setAttr ".rlc" -type "stringArray" 3 "liquidAE_LifColor( \"color\", -1, \"color\", \"Color\", {\"0\", \"0\"}, \"Required parameter\", 14 );" "liquidAE_LifFloat( \"color_multiplier\", -1, \"float\", \"Color Multiplier\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"alpha_multiplier\", -1, \"slider\", \"Alpha Multiplier\", {\"0\", \"1\"}, \"\", 14 );"  ;
	...
	setAttr -k on ".color" -type "float3" 1 0 0 ;
