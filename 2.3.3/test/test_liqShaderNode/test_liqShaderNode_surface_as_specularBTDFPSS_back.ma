...
//Name: test_liqShaderNode_surface_as_specularBTDFPSS_back.ma
//Last modified: Fri, Sep 07, 2012 11:07:29 PM
//Codeset: 936
requires maya "2012";
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_liqShaderNode_surface_as_specularBTDFPSS_back19.xml";
...
createNode liquidShader -n "liquidShader13";
	...
	addAttr -ci true -h true -k true -sn "reflectancec" -ln "reflectancec" -at "float" 
		-p "reflectance";
	addAttr -ci true -h true -sn "reflectance_multiplier" -ln "reflectance_multiplier" 
		-at "double";
	...
	setAttr ".rms" -type "string" "specular_btdf0";
	setAttr ".rst" -type "string" "specular_btdf";
	setAttr ".rml" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_as_simple/specularBTDF.dll";
	setAttr ".rpr" -type "stringArray" 6 "reflectance" "reflectance_multiplier" "transmittance" "transmittance_multiplier" "from_ior" "to_ior"  ;
	setAttr ".rdt" -type "stringArray" 6 "uniform" "uniform" "uniform" "uniform" "uniform" "uniform"  ;
	setAttr ".rty" -type "stringArray" 6 "color" "float" "color" "float" "float" "float"  ;
	setAttr ".rdf" -type "stringArray" 6 "1.01.01.0" "1.0" "1.01.01.0" "1.0" "1.0" "1.5"  ;
	setAttr ".ras" -type "Int32Array" 6 -1 -1 -1 -1 -1 -1 ;
	setAttr ".rlc" -type "stringArray" 12 "liquidAE_LifGrp( \"Reflectance\", 14 );" "liquidAE_LifColor( \"reflectance\", -1, \"color\", \"Reflectance\", {\"0\", \"0\"}, \"reflectance\\nrequired\", 14 );" "liquidAE_LifFloat( \"reflectance_multiplier\", -1, \"float\", \"Multiplier\", {\"0\", \"0\"}, \"reflectance_multiplier\\noptional\", 14 );" "liquidAE_LifGrp( \"end\", 14 );" "liquidAE_LifGrp( \"Transmittance\", 14 );" "liquidAE_LifColor( \"transmittance\", -1, \"color\", \"Transmittance\", {\"0\", \"0\"}, \"transmittance\\nrequired\", 14 );" "liquidAE_LifFloat( \"transmittance_multiplier\", -1, \"float\", \"Multiplier\", {\"0\", \"0\"}, \"transmittance_multiplier\\nrequired\", 14 );" "liquidAE_LifGrp( \"end\", 14 );" "liquidAE_LifGrp( \"Index of Refraction\", 14 );" "liquidAE_LifFloat( \"from_ior\", -1, \"float\", \"From\", {\"0\", \"0\"}, \"from_ior\\nrequired\", 14 );" "liquidAE_LifFloat( \"to_ior\", -1, \"float\", \"To\", {\"0\", \"0\"}, \"to_ior\\nrequired\", 14 );" "liquidAE_LifGrp( \"end\", 14 );"  ;
	setAttr ".rmt" -type "stringArray" 0  ;
	setAttr ".rio" -type "Int32Array" 6 0 0 0 0 0 0 ;
	setAttr -k on ".reflectance" -type "float3" 1 0 0 ;
	setAttr ".reflectance_multiplier" 1;
...
connectAttr "liquidShader14.oc" "liquidShader12SG.liqBRDF_back";
...
// End of test_liqShaderNode_surface_as_specularBTDFPSS_back.ma
