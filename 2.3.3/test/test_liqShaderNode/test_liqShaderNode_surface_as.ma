...
//Name: test_liqShaderNode_surface_as.ma
//Last modified: Wed, Aug 22, 2012 11:40:36 PM
//Codeset: 936
requires maya "2012";
requires "liquid_2012x32d" "2.3.5 (buildtime=23:19:41.60)";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 49.209503809908782 90.808451822631696 109.0359756665508 ;
	setAttr ".r" -type "double3" -38.138352729615136 17.800000000001354 1.6702323789750483e-015 ;
	setAttr ".rp" -type "double3" 7.1054273576010019e-015 1.7763568394002505e-015 0 ;
	setAttr ".rpt" -type "double3" -1.7108855594483011e-015 -2.9231787039383996e-016 
		-4.7264245134649737e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 152.82171669594982;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 12.465657623492504 -3.5685090651974747 -5.4077053075569381 ;
...
createNode transform -n "pPlane1";
	setAttr ".t" -type "double3" -14.649216406831124 0 -1.8054900218442107 ;
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	...
	setAttr -s 4 ".pt[0:3]" -type "float3"  -19.316353 0 30.184214 24.918037 
		0 30.184214 -19.316353 0 -27.244406 24.918037 0 -27.244406;
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" 16.332294821906871 27.991908301424093 0 ;
createNode pointLight -n "pointLightShape1" -p "pointLight1";
	setAttr -k off ".v";
	setAttr ".us" no;
createNode transform -n "pPlane2";
	setAttr ".t" -type "double3" 45.450059549560535 -0.15870636679427186 0.6241436477481912 ;
	setAttr ".s" -type "double3" 0.48396905237784321 1 2.1770657508013929 ;
createNode transform -n "pPlane3";
	setAttr ".t" -type "double3" 41.815317720438877 0 -0.41435744632214266 ;
createNode mesh -n "pPlaneShape2" -p "pPlane3";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_liqShaderNode_surface_as32653.xml";
...
createNode liquidSurface -n "liquidSurface2";
	...
	setAttr -k on ".lambertian_brdf_reflectance" -type "float3" 0.75439078 0.75439078 
		0.75439078 ;
	...
	setAttr -k on ".lambertian_brdf_reflectance_multiplier";
...
createNode liquidShader -n "liquidShader1";
	...
	setAttr ".rio" -type "Int32Array" 6 0 0 0 0 0 0 ;
	setAttr ".bsdf_model" -type "string" "lambertian_brdf";
	setAttr -k on ".lambertian_brdf_reflectance" -type "float3" 0.78362709 0.78362709 
		0.78362709 ;
	setAttr -k on ".lambertian_brdf_reflectance_multiplier";
	setAttr ".edf_model" -type "string" "diffuse_edf";
...
createNode polyPlane -n "polyPlane2";
	setAttr ".w" 48.789871495255497;
	setAttr ".h" 73.565502242008876;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
...
connectAttr "file1.oc" "liquidSurface2.lambertian_brdf_reflectance_multiplier";
connectAttr "liquidSurface2.oc" "liquidSurface2SG.ss";
connectAttr "pPlaneShape1.iog" "liquidSurface2SG.dsm" -na;
...
connectAttr "file1.oc" "liquidShader1.lambertian_brdf_reflectance_multiplier";
...
connectAttr "liquidShader1.msg" "materialInfo3.m";
connectAttr "liquidShader1.msg" "materialInfo3.t" -na;
...
// End of test_liqShaderNode_surface_as.ma
