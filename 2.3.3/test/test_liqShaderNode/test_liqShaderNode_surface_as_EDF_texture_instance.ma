...
//Name: test_liqShaderNode_surface_as_EDF_texture_instance.ma
//Last modified: Sat, Nov 17, 2012 03:18:08 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 9.3556409349091769 7.9305485234531137 9.3556409349091894 ;
	setAttr ".r" -type "double3" -30.938352729602599 45.000000000000028 0 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_liqShaderNode_surface_as_EDF_texture_instance208.xml";
...
createNode liquidShader -n "liquidShader13";
	addAttr -ci true -uac -h true -k true -sn "transmittance" -ln "transmittance" -at "float3" 
		-nc 3;
	addAttr -ci true -h true -k true -sn "transmittancea" -ln "transmittancea" -at "float" 
		-p "transmittance";
	addAttr -ci true -h true -k true -sn "transmittanceb" -ln "transmittanceb" -at "float" 
		-p "transmittance";
	addAttr -ci true -h true -k true -sn "transmittancec" -ln "transmittancec" -at "float" 
		-p "transmittance";
	addAttr -ci true -h true -sn "transmittance_multiplier" -ln "transmittance_multiplier" 
		-at "double";
	addAttr -ci true -h true -sn "from_ior" -ln "from_ior" -at "double";
	addAttr -ci true -h true -sn "to_ior" -ln "to_ior" -at "double";
	addAttr -ci true -uac -h true -sn "reflectance" -ln "reflectance" -at "float3" -nc 
		3;
	...
	setAttr -k on ".transmittance" -type "float3" 1 1 0 ;
	setAttr ".transmittance_multiplier" 1;
	setAttr ".from_ior" 1;
	setAttr ".to_ior" 1.5;
	setAttr ".reflectance" -type "float3" 1 0 0 ;
...
createNode liquidShader -n "liquidShader14";
	...
	setAttr ".ras" -type "Int32Array" 2 -1 -1 ;
	setAttr ".rlc" -type "stringArray" 4 "liquidAE_LifGrp( \"Exitance\", 14 );" "liquidAE_LifColor( \"exitance\", -1, \"color\", \"Exitance\", {\"0\", \"0\"}, \"exitance\\nRequired\", 14 );" "liquidAE_LifFloat( \"exitance_multiplier\", -1, \"float\", \"Multiplier\", {\"0\", \"0\"}, \"exitance_multiplier\\nRequired\", 14 );" "liquidAE_LifGrp( \"end\", 14 );"  ;
	setAttr ".rmt" -type "stringArray" 0  ;
	setAttr ".rio" -type "Int32Array" 2 0 0 ;
	setAttr -k on ".exitance";
...
connectAttr "liquidShader13.oc" "liquidShader12SG.liqBRDF";
connectAttr "liquidShader14.oc" "liquidShader12SG.liqEDF";
...
connectAttr "file1.oc" "liquidShader14.exitance";
...
// End of test_liqShaderNode_surface_as_EDF_texture_instance.ma
