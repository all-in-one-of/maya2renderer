...
//Last modified: Sat, Nov 17, 2012 03:20:51 PM
//Codeset: 936
requires maya "2012";
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_liqShaderNode_surface_as_lambertAOSS169.xml";
...
createNode liquidShader -n "liquidShader_ao";
	...
	setAttr ".rlc" -type "stringArray" 3 "liquidAE_LifParameter( \"sampling_method\", \"-1\", \"string\", \"selector\", \"Sampling Method\", {\"Cosine-Weighted Sampling\", \"cosine\", \"Uniform Sampling\", \"uniform\"}, \"Required parameter\", 14 );" "liquidAE_LifParameter( \"samples\", \"-1\", \"float\", \"float\", \"Samples\", {\"\"}, \"\", 14 );" "liquidAE_LifParameter( \"max_distance\", \"-1\", \"float\", \"float\", \"Maximum Occlusion Distance\", {\"\"}, \"\", 14 );"  ;
	...
	setAttr ".sampling_method" -type "string" "cosine";
	setAttr ".samples" 16;
