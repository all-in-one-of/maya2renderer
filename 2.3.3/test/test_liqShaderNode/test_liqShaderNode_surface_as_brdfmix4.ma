...
//Name: test_liqShaderNode_surface_as_brdfmix4.ma
//Last modified: Sat, Nov 17, 2012 03:15:36 PM
//Codeset: 936
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.5044620880947015 68.418165074128311 -0.99220760933393493 ;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode transform -n "pPlane_L1";
	setAttr ".t" -type "double3" 1.8617072439878957 0 -1.8172749423550822 ;
createNode mesh -n "pPlane_LShape1" -p "pPlane_L1";
...
createNode pointLight -n "pointLightShape1" -p "pointLight1";
	setAttr -k off ".v";
	setAttr ".us" no;
createNode transform -n "pPlane_L0";
	setAttr ".t" -type "double3" -7.3455287668466109 -1.7051729890453587e-015 -0.80133041092874358 ;
createNode mesh -n "pPlane_LShape0" -p "pPlane_L0";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_liqShaderNode_surface_as_brdfmix471.xml";
...
createNode liquidShader -n "liquidShader_I00";
	...
	setAttr -k on ".reflectance" -type "float3" 0 0 1 ;
	setAttr -k on ".reflectance";
	setAttr -k on ".reflectance_multiplier" -type "float3" 1 1 1 ;
createNode liquidShader -n "liquidShader_I01";
	addAttr -ci true -uac -h true -k true -sn "reflectance" -ln "reflectance" -at "float3" 
		-nc 3;
	addAttr -ci true -h true -k true -sn "reflectancea" -ln "reflectancea" -at "float" 
		-p "reflectance";
	...
	setAttr -k on ".reflectance";
	setAttr -k on ".reflectance_multiplier" -type "float3" 1 1 1 ;
createNode liquidShader -n "liquidShader_bsdfmix_L0";
	...
	addAttr -ci true -uac -h true -k true -sn "outPlugForLiquid" -ln "outPlugForLiquid" 
		-at "float3" -nc 3;
	addAttr -ci true -h true -k true -sn "outPlugForLiquida" -ln "outPlugForLiquida" 
		-at "float" -p "outPlugForLiquid";
	addAttr -ci true -h true -k true -sn "outPlugForLiquidb" -ln "outPlugForLiquidb" 
		-at "float" -p "outPlugForLiquid";
	addAttr -ci true -h true -k true -sn "outPlugForLiquidc" -ln "outPlugForLiquidc" 
		-at "float" -p "outPlugForLiquid";
	...
	setAttr ".rpr" -type "stringArray" 5 "bsdf0" "bsdf1" "weight0" "weight1" "outPlugForLiquid"  ;
	setAttr ".rdt" -type "stringArray" 5 "uniform" "uniform" "uniform" "uniform" "uniform"  ;
	setAttr ".rty" -type "stringArray" 5 "color" "color" "float" "float" "color"  ;
	setAttr ".rdf" -type "stringArray" 5 "1.01.01.0" "1.01.01.0" "0.5" "0.5" "1.01.01.0"  ;
	setAttr ".ras" -type "Int32Array" 5 -1 -1 -1 -1 -1 ;
	setAttr ".rlc" -type "stringArray" 4 "liquidAE_LifColor( \"bsdf0\", -1, \"color\", \"BSDF 1\", {\"0\", \"0\"}, \"bsdf0\\nRequired\", 14 );" "liquidAE_LifFloat( \"weight0\", -1, \"float\", \"Weight 1\", {\"0\", \"0\"}, \"weight0\\nRequired\", 14 );" "liquidAE_LifColor( \"bsdf1\", -1, \"color\", \"BSDF 2\", {\"0\", \"0\"}, \"bsdf1\\nRequired\", 14 );" "liquidAE_LifFloat( \"weight1\", -1, \"float\", \"Weight 2\", {\"0\", \"0\"}, \"weight1\\nRequired\", 14 );"  ;
	setAttr ".rmt" -type "stringArray" 0  ;
	...
	setAttr ".weight0" 0.5;
	setAttr ".weight1" 0.5;
	setAttr -k on ".outPlugForLiquid" -type "float3" 1 1 1 ;
	setAttr -k on ".outPlugForLiquid";
...
createNode liquidShader -n "liquidShader_bsdfmix_L1";
	addAttr -ci true -uac -h true -sn "bsdf0" -ln "bsdf0" -at "float3" -nc 3;
	addAttr -ci true -h true -sn "bsdf0R" -ln "bsdf0R" -at "float" -p "bsdf0";
	addAttr -ci true -h true -sn "bsdf0G" -ln "bsdf0G" -at "float" -p "bsdf0";
	addAttr -ci true -h true -sn "bsdf0B" -ln "bsdf0B" -at "float" -p "bsdf0";
	addAttr -ci true -uac -h true -sn "bsdf1" -ln "bsdf1" -at "float3" -nc 3;
	addAttr -ci true -h true -sn "bsdf1R" -ln "bsdf1R" -at "float" -p "bsdf1";
	addAttr -ci true -h true -sn "bsdf1G" -ln "bsdf1G" -at "float" -p "bsdf1";
	addAttr -ci true -h true -sn "bsdf1B" -ln "bsdf1B" -at "float" -p "bsdf1";
	addAttr -ci true -h true -sn "weight0" -ln "weight0" -at "double";
	addAttr -ci true -h true -sn "weight1" -ln "weight1" -at "double";
	addAttr -ci true -uac -h true -k true -sn "outPlugForLiquid" -ln "outPlugForLiquid" 
		-at "float3" -nc 3;
	addAttr -ci true -h true -k true -sn "outPlugForLiquidR" -ln "outPlugForLiquidR" 
		-at "float" -p "outPlugForLiquid";
	addAttr -ci true -h true -k true -sn "outPlugForLiquidG" -ln "outPlugForLiquidG" 
		-at "float" -p "outPlugForLiquid";
	addAttr -ci true -h true -k true -sn "outPlugForLiquidB" -ln "outPlugForLiquidB" 
		-at "float" -p "outPlugForLiquid";
	...
	setAttr ".rdf" -type "stringArray" 5 "1.01.01.0" "1.01.01.0" "0.5" "0.5" "1.01.01.0"  ;
	setAttr ".ras" -type "Int32Array" 5 -1 -1 -1 -1 -1 ;
	setAttr ".rlc" -type "stringArray" 4 "liquidAE_LifParameter( \"bsdf0\", \"-1\", \"color\", \"color\", \"BSDF 1\", {\"\"}, \"bsdf0\\nRequired\", 14 );" "liquidAE_LifParameter( \"weight0\", \"-1\", \"float\", \"float\", \"Weight 1\", {\"\"}, \"weight0\\nRequired\", 14 );" "liquidAE_LifParameter( \"bsdf1\", \"-1\", \"color\", \"color\", \"BSDF 2\", {\"\"}, \"bsdf1\\nRequired\", 14 );" "liquidAE_LifParameter( \"weight1\", \"-1\", \"float\", \"float\", \"Weight 2\", {\"\"}, \"weight1\\nRequired\", 14 );"  ;
	setAttr ".rmt" -type "stringArray" 0  ;
	setAttr ".rio" -type "Int32Array" 5 0 0 0 0 0 ;
	...
	setAttr ".weight1" 0.5;
	setAttr -k on ".outPlugForLiquid" -type "float3" 1 1 1 ;
	setAttr ".rmanParamLifCmdId" -type "Int32Array" 5 0 2 1 3
		 0 ;
	setAttr ".rmanGroups" -type "stringArray" 0  ;
	setAttr ".rmanGroupLifCmdId" -type "Int32Array" 0 ;
createNode liquidShader -n "liquidShader_I10";
	addAttr -ci true -uac -h true -sn "reflectance" -ln "reflectance" -at "float3" 
		-nc 3;
	addAttr -ci true -h true -sn "reflectanceR" -ln "reflectanceR" -at "float" -p "reflectance";
	addAttr -ci true -h true -sn "reflectanceG" -ln "reflectanceG" -at "float" -p "reflectance";
	addAttr -ci true -h true -sn "reflectanceB" -ln "reflectanceB" -at "float" -p "reflectance";
	addAttr -ci true -uac -h true -sn "reflectance_multiplier" -ln "reflectance_multiplier" 
		-at "float3" -nc 3;
	addAttr -ci true -h true -sn "reflectance_multiplierR" -ln "reflectance_multiplierR" 
		-at "float" -p "reflectance_multiplier";
	addAttr -ci true -h true -sn "reflectance_multiplierG" -ln "reflectance_multiplierG" 
		-at "float" -p "reflectance_multiplier";
	addAttr -ci true -h true -sn "reflectance_multiplierB" -ln "reflectance_multiplierB" 
		-at "float" -p "reflectance_multiplier";
	addAttr -ci true -h true -sn "rmanParamLifCmdId" -ln "rmanParamLifCmdId" -dt "Int32Array";
	addAttr -ci true -h true -sn "rmanGroups" -ln "rmanGroups" -dt "stringArray";
	addAttr -ci true -h true -sn "rmanGroupLifCmdId" -ln "rmanGroupLifCmdId" -dt "Int32Array";
	...
	setAttr ".rdf" -type "stringArray" 2 "1.01.01.0" "1.01.01.0"  ;
	setAttr ".ras" -type "Int32Array" 2 -1 -1 ;
	setAttr ".rlc" -type "stringArray" 2 "liquidAE_LifParameter( \"reflectance\", \"-1\", \"color\", \"color\", \"Reflectance\", {\"\"}, \"reflectance\\nrequired\", 14 );" "liquidAE_LifParameter( \"reflectance_multiplier\", \"-1\", \"color\", \"color\", \"Reflectance Multiplier\", {\"\"}, \"reflectance_multiplier\\noptional\", 14 );"  ;
	setAttr ".rmt" -type "stringArray" 0  ;
	setAttr ".rio" -type "Int32Array" 2 0 0 ;
	setAttr ".rma" -type "stringArray" 2 "" ""  ;
	setAttr ".reflectance" -type "float3" 1 1 1 ;
	setAttr ".reflectance_multiplier" -type "float3" 1 1 1 ;
	setAttr ".rmanParamLifCmdId" -type "Int32Array" 2 0 1 ;
	setAttr ".rmanGroups" -type "stringArray" 0  ;
	setAttr ".rmanGroupLifCmdId" -type "Int32Array" 0 ;
createNode polyPlane -n "polyPlane2";
	setAttr ".ax" -type "double3" 0 1 2.2204460492503131e-016 ;
	setAttr ".w" 12.821286574859538;
	setAttr ".h" 15.358832876133825;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "polyPlane1.out" "pPlane_LShape1.i";
connectAttr "polyPlane2.out" "pPlane_LShape0.i";
...
connectAttr "liquidShader_I00.reflectance" "liquidShader_bsdfmix_L0.bsdf0";
connectAttr "liquidShader_I01.reflectance" "liquidShader_bsdfmix_L0.bsdf1";
connectAttr "liquidShader_surface.oc" "lambert2SG.ss";
connectAttr "pPlane_LShape1.iog" "lambert2SG.dsm" -na;
connectAttr "liquidShader_bsdfmix_L1.oc" "lambert2SG.liqBRDF";
connectAttr "lambert2SG.msg" "materialInfo2.sg";
connectAttr "liquidShader_surface.msg" "materialInfo2.m";
connectAttr "liquidShader_surface.msg" "materialInfo2.t" -na;
connectAttr "liquidShader_bsdfmix_L0.outPlugForLiquid" "liquidShader_bsdfmix_L1.bsdf0"
		;
connectAttr "liquidShader_I10.reflectance" "liquidShader_bsdfmix_L1.bsdf1";
connectAttr "liquidShader_surface.oc" "lambert3SG.ss";
connectAttr "pPlane_LShape0.iog" "lambert3SG.dsm" -na;
connectAttr "liquidShader_bsdfmix_L0.oc" "lambert3SG.liqBRDF";
connectAttr "lambert3SG.msg" "materialInfo3.sg";
connectAttr "liquidShader_surface.msg" "materialInfo3.m";
connectAttr "liquidShader_surface.msg" "materialInfo3.t" -na;
connectAttr "lambert2SG.pa" ":renderPartition.st" -na;
connectAttr "lambert3SG.pa" ":renderPartition.st" -na;
connectAttr "liquidShader_surface.msg" ":defaultShaderList1.s" -na;
connectAttr "liquidShader_I00.msg" ":defaultShaderList1.s" -na;
connectAttr "liquidShader_I01.msg" ":defaultShaderList1.s" -na;
connectAttr "liquidShader_bsdfmix_L0.msg" ":defaultShaderList1.s" -na;
connectAttr "liquidShader_bsdfmix_L1.msg" ":defaultShaderList1.s" -na;
connectAttr "liquidShader_I10.msg" ":defaultShaderList1.s" -na;
connectAttr "file1.msg" ":defaultTextureList1.tx" -na;
connectAttr "pointLightShape1.ltd" ":lightList1.l" -na;
connectAttr "place2dTexture1.msg" ":defaultRenderUtilityList1.u" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "pointLight1.iog" ":defaultLightSet.dsm" -na;
// End of test_liqShaderNode_surface_as_brdfmix4.ma
