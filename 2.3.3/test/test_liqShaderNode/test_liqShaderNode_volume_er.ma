...
//Name: er_volume2.ma
//Last modified: Thu, Aug 16, 2012 08:29:46 PM
//Codeset: 936
requires maya "2012";
requires "liquid_2012x32d" "2.3.5 (buildtime=22:34:50.12)";
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/er_volume2544.xml";
...
createNode liquidSurface -n "liquidSurface1";
	...
	addAttr -ci true -uac -h true -k true -sn "vol_color" -ln "vol_color" -at "float3" 
		-nc 3;
	addAttr -ci true -h true -k true -sn "vol_colora" -ln "vol_colora" -at "float" -p "vol_color";
	addAttr -ci true -h true -k true -sn "vol_colorb" -ln "vol_colorb" -at "float" -p "vol_color";
	addAttr -ci true -h true -k true -sn "vol_colorc" -ln "vol_colorc" -at "float" -p "vol_color";
	...
	addAttr -ci true -h true -k true -sn "vol_offset" -ln "vol_offset" -at "double3" 
		-nc 3;
	addAttr -ci true -h true -k true -sn "vol_offseta" -ln "vol_offseta" -at "double" 
		-p "vol_offset";
	addAttr -ci true -h true -k true -sn "vol_offsetb" -ln "vol_offsetb" -at "double" 
		-p "vol_offset";
	addAttr -ci true -h true -k true -sn "vol_offsetc" -ln "vol_offsetc" -at "double" 
		-p "vol_offset";
	...
	setAttr -k on ".vol_color" -type "float3" 0 1 0 ;
	setAttr ".vol_density" 7.1249999983701855;
...
createNode liquidSurface -n "liquidSurface2";
	...
	setAttr ".rmt" -type "stringArray" 0  ;
	setAttr ".rio" -type "Int32Array" 0 ;
createNode liquidVolume -n "liquidVolume1";
	addAttr -ci true -uac -h true -k true -sn "vol_color" -ln "vol_color" -at "float3" 
		-nc 3;
	addAttr -ci true -h true -k true -sn "vol_colora" -ln "vol_colora" -at "float" -p "vol_color";
	addAttr -ci true -h true -k true -sn "vol_colorb" -ln "vol_colorb" -at "float" -p "vol_color";
	...
	setAttr ".ras" -type "Int32Array" 7 -1 -1 -1 -1 -1 -1
		 -1 ;
	setAttr ".rlc" -type "stringArray" 7 "liquidAE_LifColor( \"vol_color\", -1, \"color\", \"vol_color\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"vol_density\", -1, \"float\", \"vol_density\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"step_size\", -1, \"float\", \"step_size\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"vol_radius\", -1, \"float\", \"vol_radius\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifVector( \"vol_offset\", -1, \"vector\", \"vol_offset\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"absorption\", -1, \"float\", \"absorption\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"anisotropic\", -1, \"float\", \"anisotropic\", {\"0\", \"0\"}, \"\", 14 );"  ;
	setAttr ".rmt" -type "stringArray" 0  ;
	setAttr ".rio" -type "Int32Array" 7 0 0 0 0 0 0
		 0 ;
	setAttr -k on ".vol_color" -type "float3" 1 1 0 ;
	setAttr ".vol_density" 3;
	setAttr ".step_size" 0.5;
	setAttr ".vol_radius" 3;
	setAttr ".absorption" 0.3;
	setAttr ".anisotropic" 0.4;
...
connectAttr "liquidShader2.oc" "liquidSurface1SG.ss";
connectAttr "pCubeShape1.iog" "liquidSurface1SG.dsm" -na;
connectAttr "liquidShader3.oc" "liquidSurface1SG.liqShadowShader";
connectAttr "liquidShader1.oc" "liquidSurface1SG.vs";
connectAttr "liquidSurface1SG.msg" "materialInfo1.sg";
connectAttr "liquidShader2.msg" "materialInfo1.m";
connectAttr "liquidShader2.msg" "materialInfo1.t" -na;
...
connectAttr "liquidVolume1.msg" ":defaultShaderList1.s" -na;
