...
//Name: test_liqShaderNode_er.ma
//Last modified: Thu, Aug 16, 2012 12:00:39 AM
//Codeset: 936
requires maya "2012";
...
createNode transform -n "pointLight1";
	setAttr ".t" -type "double3" 0 3.6668767523143071 0 ;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_liqShaderNode_er590.xml";
...
createNode script -n "liquidCleanUpNode";
	...
	setAttr ".st" 2;
createNode liquidShader -n "liquidShader_base0";
	...
	addAttr -ci true -h true -sn "mode2" -ln "mode2" -at "double";
	...
	setAttr -k on ".Cs" -type "double3" 0.76 0 0 ;
	setAttr -k on ".Kd" -type "double3" 1 1 1 ;
	setAttr ".Ks" 0.5;
	setAttr ".roughness" 0.1;
	setAttr -k on ".specularcolor" -type "float3" 1 1 0 ;
	setAttr ".frequency" 8.5;
	setAttr ".mode2" 0.5;
...
createNode liquidShader -n "liquidShader_base1";
	addAttr -ci true -h true -k true -sn "Cs" -ln "Cs" -at "double3" -nc 3;
	addAttr -ci true -h true -k true -sn "Csa" -ln "Csa" -at "double" -p "Cs";
	addAttr -ci true -h true -k true -sn "Csb" -ln "Csb" -at "double" -p "Cs";
	addAttr -ci true -h true -k true -sn "Csc" -ln "Csc" -at "double" -p "Cs";
...
createNode liquidShader -n "liquidShader_base2";
	addAttr -ci true -h true -k true -sn "Cs" -ln "Cs" -at "double3" -nc 3;
	addAttr -ci true -h true -k true -sn "Csa" -ln "Csa" -at "double" -p "Cs";
	addAttr -ci true -h true -k true -sn "Csb" -ln "Csb" -at "double" -p "Cs";
	addAttr -ci true -h true -k true -sn "Csc" -ln "Csc" -at "double" -p "Cs";
...
connectAttr "liquidShader_base0.oc" "liquidShader2SG.ss";
connectAttr "liquidShader2SG.msg" "materialInfo2.sg";
connectAttr "liquidShader_base0.msg" "materialInfo2.m";
connectAttr "liquidShader_base0.msg" "materialInfo2.t" -na;
connectAttr "liquidShader_I0.Cs" "liquidShader_base1.Cs";
connectAttr "liquidShader_I1.specularcolor" "liquidShader_base1.specularcolor";
connectAttr "liquidShader_base1.oc" "liquidShader3SG.ss";
connectAttr "liquidShader3SG.msg" "materialInfo3.sg";
connectAttr "liquidShader_base1.msg" "materialInfo3.m";
connectAttr "liquidShader_base1.msg" "materialInfo3.t" -na;
connectAttr "liquidShader_I0.oc" "liquidShader4SG.ss";
connectAttr "liquidShader4SG.msg" "materialInfo4.sg";
connectAttr "liquidShader_I0.msg" "materialInfo4.m";
connectAttr "liquidShader_I0.msg" "materialInfo4.t" -na;
connectAttr "liquidShader_I1.oc" "liquidShader5SG.ss";
connectAttr "liquidShader5SG.msg" "materialInfo5.sg";
connectAttr "liquidShader_I1.msg" "materialInfo5.m";
connectAttr "liquidShader_I1.msg" "materialInfo5.t" -na;
connectAttr "lambert2.ambc" "liquidShader_base2.Cs";
connectAttr "phong1.ambc" "liquidShader_base2.specularcolor";
connectAttr "liquidShader_base2.oc" "liquidShader6SG.ss";
connectAttr "pPlaneShape1.iog" "liquidShader6SG.dsm" -na;
connectAttr "liquidShader6SG.msg" "materialInfo6.sg";
connectAttr "liquidShader_base2.msg" "materialInfo6.m";
connectAttr "liquidShader_base2.msg" "materialInfo6.t" -na;
...
connectAttr "liquidShader_base0.msg" ":defaultShaderList1.s" -na;
connectAttr "liquidShader_base1.msg" ":defaultShaderList1.s" -na;
connectAttr "liquidShader_I0.msg" ":defaultShaderList1.s" -na;
connectAttr "liquidShader_I1.msg" ":defaultShaderList1.s" -na;
connectAttr "liquidShader_base2.msg" ":defaultShaderList1.s" -na;
...
// End of test_liqShaderNode_er.ma
