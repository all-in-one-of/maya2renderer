...
//Name: test_liqShaderNode_surface_as_lambertDiagnosticSS.ma
//Last modified: Sat, Sep 01, 2012 08:40:39 PM
//Codeset: 936
requires maya "2012";
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_liqShaderNode_surface_as_lambertDiagnosticSS534.xml";
...
createNode liquidShader -n "liquidShader6";
	...
	addAttr -ci true -h true -sn "diagnostic_surface_shader_mode" -ln "diagnostic_surface_shader_mode" 
		-dt "string";
	...
	addAttr -ci true -h true -sn "mode" -ln "mode" -dt "string";
	setAttr ".rms" -type "string" "diagnostic_surface_shader0";
	setAttr ".rst" -type "string" "diagnostic_surface_shader";
	setAttr ".rml" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_as_simple/DiagnosticSurfaceShader.dll";
	setAttr ".rpr" -type "stringArray" 1 "mode"  ;
	setAttr ".rdt" -type "stringArray" 1 "uniform"  ;
	setAttr ".rty" -type "stringArray" 1 "string"  ;
	setAttr ".rdf" -type "stringArray" 1 "ambient_occlusion"  ;
	setAttr ".ras" -type "Int32Array" 1 -1 ;
	setAttr ".rlc" -type "stringArray" 1 "liquidAE_LifString( \"mode\", -1, \"selector\", \"Mode\", {\"Ambient Occlusion\", \"ambient_occlusion\", \"Assembly Instances\", \"assembly_instances\", \"Barycentric Coordinates\", \"barycentric\", \"Bitangents\", \"bitangent\", \"Coverage\", \"coverage\", \"Depth\", \"depth\", \"Geometric Normals\", \"geometric_normal\", \"Materials\", \"materials\", \"Object Instances\", \"object_instances\", \"Original Shading Normals\", \"original_shading_normal\", \"Regions\", \"regions\", \"Shading Normals\", \"shading_normal\", \"Sides\", \"sides\", \"Tangents\", \"tangent\", \"Triangles\", \"triangles\", \"UV Coordinates\", \"uv\", \"Wireframe\", \"wireframe\"}, \"mode\\nRequired\", 14 );"  ;
	setAttr ".rmt" -type "stringArray" 0  ;
	setAttr ".rio" -type "Int32Array" 1 0 ;
	setAttr ".bsdf_model" -type "string" "lambertian_brdf";
	setAttr -k on ".lambertian_brdf_reflectance" -type "float3" 0 1 0 ;
	...
	setAttr ".surface_shader_model" -type "string" "diagnostic_surface_shader";
	setAttr ".diagnostic_surface_shader_mode" -type "string" "wireframe";
	setAttr ".use_bsdf" yes;
	setAttr ".use_edf" yes;
	setAttr ".mode" -type "string" "barycentric";
...
connectAttr "pCubeShape1.iog" "liquidShader6SG.dsm" -na;
...
// End of test_liqShaderNode_surface_as_lambertDiagnosticSS.ma
