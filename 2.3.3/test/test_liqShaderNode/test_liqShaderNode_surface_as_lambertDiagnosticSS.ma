...
//Last modified: Wed, Aug 29, 2012 08:33:19 PM
//Codeset: 936
requires maya "2012";
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_liqShaderNode_surface_as_lambertDiagnosticSS192.xml";
...
createNode liquidShader -n "liquidShader6";
	...
	setAttr ".rlc" -type "stringArray" 1 "liquidAE_LifString( \"mode\", -1, \"string\", \"mode\", {\"0\", \"0\"}, \"\", 14 );"  ;
