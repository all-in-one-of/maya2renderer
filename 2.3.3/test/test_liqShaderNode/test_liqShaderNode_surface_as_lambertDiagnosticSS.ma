...
//Last modified: Sat, Nov 17, 2012 03:22:38 PM
//Codeset: 936
requires maya "2012";
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_liqShaderNode_surface_as_lambertDiagnosticSS113.xml";
...
createNode liquidShader -n "liquidShader6";
	...
	setAttr ".rlc" -type "stringArray" 1 "liquidAE_LifParameter( \"mode\", \"-1\", \"string\", \"selector\", \"Mode\", {\"\"}, \"mode\\nRequired\", 14 );"  ;
