...
//Name: test_liqShaderNode.ma
//Last modified: Tue, Aug 14, 2012 01:10:59 AM
//Codeset: 936
requires maya "2012";
requires "liquid_2012x32d" "2.3.5 (buildtime= 0:54:45.21)";
...
createNode transform -n "pCylinder1";
	setAttr ".t" -type "double3" 8.3775703318072985 1.9720038368284512 -1.5168027847833834 ;
...
createNode transform -n "pSphere1";
	setAttr ".t" -type "double3" 13.209858692929428 0 -7.9382649873087949 ;
...
createNode transform -n "pCone1";
	setAttr ".t" -type "double3" 16.297899761988514 1.6034627932092351 1.9201029253612418 ;
...
createNode transform -n "pCone2";
	setAttr ".t" -type "double3" 7.5852714688327261 1.4388342067168653 5.2600217814965546 ;
...
createNode polyCylinder -n "polyCylinder1";
	setAttr ".r" 3.1416536643454016;
	setAttr ".h" 3.9440076736569023;
	setAttr ".sc" 1;
	setAttr ".cuv" 3;
...
createNode polySphere -n "polySphere1";
	setAttr ".r" 2.3336946614193881;
createNode polyCone -n "polyCone1";
	setAttr ".r" 1.4473304129118987;
	setAttr ".h" 3.2069255864184703;
	setAttr ".cuv" 3;
...
createNode polyCone -n "polyCone2";
	setAttr ".r" 3.2185250278486466;
	setAttr ".h" 2.8776684134337307;
	setAttr ".cuv" 3;
...
connectAttr "liquidShader1SG.msg" "materialInfo1.sg";
connectAttr "liquidShader2.oc" "liquidShader2SG.ss";
connectAttr "pCylinderShape1.iog" "liquidShader2SG.dsm" -na;
connectAttr "liquidShader2SG.msg" "materialInfo2.sg";
connectAttr "liquidShader2.msg" "materialInfo2.m";
connectAttr "liquidShader2.msg" "materialInfo2.t" -na;
connectAttr "liquidSurface1.oc" "liquidSurface1SG.ss";
connectAttr "pSphereShape1.iog" "liquidSurface1SG.dsm" -na;
connectAttr "liquidSurface1SG.msg" "materialInfo3.sg";
connectAttr "liquidSurface1.msg" "materialInfo3.m";
connectAttr "liquidSurface1.msg" "materialInfo3.t" -na;
connectAttr "liquidSurface2.oc" "liquidSurface2SG.ss";
connectAttr "pConeShape1.iog" "liquidSurface2SG.dsm" -na;
connectAttr "liquidSurface2SG.msg" "materialInfo4.sg";
connectAttr "liquidSurface2.msg" "materialInfo4.m";
connectAttr "liquidSurface2.msg" "materialInfo4.t" -na;
connectAttr "liquidShader3.oc" "liquidShader3SG.ss";
connectAttr "pConeShape2.iog" "liquidShader3SG.dsm" -na;
