...
//Name: test_liqShaderNode_volume_rm.ma
//Last modified: Sat, Aug 18, 2012 01:02:35 AM
//Codeset: 936
requires maya "2012";
requires "liquid_2012x32d" "2.3.5 (buildtime= 0:07:11.57)";
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_liqShaderNode_volume_rm130.xml";
...
createNode liquidShader -n "liquidShader5";
	...
	setAttr ".rio" -type "Int32Array" 2 0 0 ;
	setAttr ".distance" 30;
	setAttr -k on ".background" -type "float3" 0 0.43099999 0 ;
	setAttr -k on ".background";
select -ne :time1;
	setAttr -k on ".cch";
	setAttr -cb on ".ihi";
	setAttr -k on ".nds";
...
connectAttr "liquidShader5.oc" "liquidShader4SG.vs";
connectAttr "pPlaneShape1.iog" "liquidShader4SG.dsm" -na;
...
connectAttr "liquidShader7SG.msg" "materialInfo8.sg";
...
// End of test_liqShaderNode_volume_rm.ma
