...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/test_liqShaderNode_surface_as_ashikhminPSS698.xml";
...
createNode liqGlobalsNodeRenderer -n "liqGlobalsNodeRenderer_appleseed";
	...
	setAttr ".final_min_samples" 2;
	setAttr ".final_max_samples" 4;
...
createNode liquidShader -n "liquidShader10";
	addAttr -ci true -h true -sn "bsdf_model" -ln "bsdf_model" -dt "string";
	addAttr -ci true -uac -h true -k true -sn "ashikhmin_brdf_diffuse_reflectance" -ln "ashikhmin_brdf_diffuse_reflectance" 
		-at "float3" -nc 3;
	addAttr -ci true -h true -k true -sn "ashikhmin_brdf_diffuse_reflectancea" -ln "ashikhmin_brdf_diffuse_reflectancea" 
		-at "float" -p "ashikhmin_brdf_diffuse_reflectance";
	addAttr -ci true -h true -k true -sn "ashikhmin_brdf_diffuse_reflectanceb" -ln "ashikhmin_brdf_diffuse_reflectanceb" 
		-at "float" -p "ashikhmin_brdf_diffuse_reflectance";
	addAttr -ci true -h true -k true -sn "ashikhmin_brdf_diffuse_reflectancec" -ln "ashikhmin_brdf_diffuse_reflectancec" 
		-at "float" -p "ashikhmin_brdf_diffuse_reflectance";
	addAttr -ci true -h true -sn "ashikhmin_brdf_diffuse_reflectance_multiplier" -ln "ashikhmin_brdf_diffuse_reflectance_multiplier" 
		-at "double";
	addAttr -ci true -uac -h true -k true -sn "ashikhmin_brdf_glossy_reflectance" -ln "ashikhmin_brdf_glossy_reflectance" 
		-at "float3" -nc 3;
	addAttr -ci true -h true -k true -sn "ashikhmin_brdf_glossy_reflectancea" -ln "ashikhmin_brdf_glossy_reflectancea" 
		-at "float" -p "ashikhmin_brdf_glossy_reflectance";
	addAttr -ci true -h true -k true -sn "ashikhmin_brdf_glossy_reflectanceb" -ln "ashikhmin_brdf_glossy_reflectanceb" 
		-at "float" -p "ashikhmin_brdf_glossy_reflectance";
	addAttr -ci true -h true -k true -sn "ashikhmin_brdf_glossy_reflectancec" -ln "ashikhmin_brdf_glossy_reflectancec" 
		-at "float" -p "ashikhmin_brdf_glossy_reflectance";
	addAttr -ci true -h true -sn "ashikhmin_brdf_glossy_reflectance_multiplier" -ln "ashikhmin_brdf_glossy_reflectance_multiplier" 
		-at "double";
	addAttr -ci true -h true -sn "ashikhmin_brdf_shininess_u" -ln "ashikhmin_brdf_shininess_u" 
		-at "double";
	addAttr -ci true -h true -sn "ashikhmin_brdf_shininess_v" -ln "ashikhmin_brdf_shininess_v" 
		-at "double";
	...
	addAttr -ci true -h true -sn "diffuse_edf_exitance_multiplier" -ln "diffuse_edf_exitance_multiplier" 
		-at "double";
	addAttr -ci true -uac -h true -k true -sn "diffuse_reflectance" -ln "diffuse_reflectance" 
		-at "float3" -nc 3;
	addAttr -ci true -h true -k true -sn "diffuse_reflectancea" -ln "diffuse_reflectancea" 
		-at "float" -p "diffuse_reflectance";
	addAttr -ci true -h true -k true -sn "diffuse_reflectanceb" -ln "diffuse_reflectanceb" 
		-at "float" -p "diffuse_reflectance";
	addAttr -ci true -h true -k true -sn "diffuse_reflectancec" -ln "diffuse_reflectancec" 
		-at "float" -p "diffuse_reflectance";
	addAttr -ci true -h true -sn "diffuse_reflectance_multiplier" -ln "diffuse_reflectance_multiplier" 
		-at "double";
	addAttr -ci true -uac -h true -k true -sn "glossy_reflectance" -ln "glossy_reflectance" 
		-at "float3" -nc 3;
	addAttr -ci true -h true -k true -sn "glossy_reflectancea" -ln "glossy_reflectancea" 
		-at "float" -p "glossy_reflectance";
	addAttr -ci true -h true -k true -sn "glossy_reflectanceb" -ln "glossy_reflectanceb" 
		-at "float" -p "glossy_reflectance";
	addAttr -ci true -h true -k true -sn "glossy_reflectancec" -ln "glossy_reflectancec" 
		-at "float" -p "glossy_reflectance";
	addAttr -ci true -h true -sn "glossy_reflectance_multiplier" -ln "glossy_reflectance_multiplier" 
		-at "double";
	addAttr -ci true -h true -sn "shininess_u" -ln "shininess_u" -at "double";
	addAttr -ci true -h true -sn "shininess_v" -ln "shininess_v" -at "double";
	...
	setAttr ".rlc" -type "stringArray" 6 "liquidAE_LifFloat( \"color_multiplier\", -1, \"float\", \"Color Multiplier\", {\"0\", \"0\"}, \"optional\", 14 );" "liquidAE_LifFloat( \"alpha_multiplier\", -1, \"float\", \"Alpha Multiplier\", {\"0\", \"0\"}, \"optional\", 14 );" "liquidAE_LifString( \"aerial_persp_mode\", -1, \"selector\", \"Aerial Perspective Mode\", {\"none\", \"none\", \"environment_shader\", \"environment_shader\", \"sky_color\", \"sky_color\"}, \"optional\", 14 );" "liquidAE_LifColor( \"aerial_persp_sky_color\", -1, \"color\", \"Aerial Perspective Sky Color\", {\"0\", \"0\"}, \"optional\", 14 );" "liquidAE_LifFloat( \"aerial_persp_distance\", -1, \"float\", \"Aerial Perspective Distance\", {\"0\", \"0\"}, \"optional\", 14 );" "liquidAE_LifFloat( \"aerial_persp_intensity\", -1, \"float\", \"Aerial Perspective Intensity\", {\"0\", \"0\"}, \"optional\", 14 );"  ;
	setAttr ".rmt" -type "stringArray" 0  ;
	setAttr ".rio" -type "Int32Array" 6 0 0 0 0 0 0 ;
	setAttr ".bsdf_model" -type "string" "ashikhmin_brdf";
	setAttr -k on ".ashikhmin_brdf_diffuse_reflectance" -type "float3" 0 1 0 ;
	setAttr ".ashikhmin_brdf_diffuse_reflectance_multiplier" 1;
	setAttr -k on ".ashikhmin_brdf_glossy_reflectance" -type "float3" 1 1 0 ;
	setAttr ".ashikhmin_brdf_glossy_reflectance_multiplier" 1;
	setAttr ".ashikhmin_brdf_shininess_u" 1000;
	setAttr ".ashikhmin_brdf_shininess_v" 1000;
	...
	setAttr ".physical_surface_shader_aerial_persp_mode" -type "string" "none";
	...
	setAttr -k on ".diffuse_reflectance" -type "float3" 0 1 0 ;
	setAttr ".diffuse_reflectance_multiplier" 1;
	setAttr -k on ".glossy_reflectance" -type "float3" 1 1 0 ;
	setAttr ".glossy_reflectance_multiplier" 1;
	setAttr ".shininess_u" 1000;
	setAttr ".shininess_v" 1000;
	setAttr ".color_multiplier" 1;
	setAttr ".alpha_multiplier" 1;
	setAttr ".aerial_persp_mode" -type "string" "sky_color";
	setAttr -k on ".aerial_persp_sky_color" -type "float3" 0 0 1 ;
...
createNode liquidShader -n "liquidShader11";
	addAttr -ci true -uac -h true -k true -sn "exitance" -ln "exitance" -at "float3" 
		-nc 3;
	addAttr -ci true -h true -k true -sn "exitancea" -ln "exitancea" -at "float" -p "exitance";
	addAttr -ci true -h true -k true -sn "exitanceb" -ln "exitanceb" -at "float" -p "exitance";
	addAttr -ci true -h true -k true -sn "exitancec" -ln "exitancec" -at "float" -p "exitance";
	addAttr -ci true -h true -sn "exitance_multiplier" -ln "exitance_multiplier" -at "double";
	setAttr ".rms" -type "string" "diffuse_edf0";
	setAttr ".rst" -type "string" "diffuse_edf";
	setAttr ".rml" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_as_simple/diffuseEDF.dll";
	setAttr ".rpr" -type "stringArray" 2 "exitance" "exitance_multiplier"  ;
	setAttr ".rdt" -type "stringArray" 2 "uniform" "uniform"  ;
	setAttr ".rty" -type "stringArray" 2 "color" "float"  ;
	setAttr ".rdf" -type "stringArray" 2 "1.01.01.0" "1.0"  ;
	setAttr ".ras" -type "Int32Array" 2 -1 -1 ;
	setAttr ".rlc" -type "stringArray" 2 "liquidAE_LifColor( \"exitance\", -1, \"color\", \"exitance\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"exitance_multiplier\", -1, \"float\", \"exitance_multiplier\", {\"0\", \"0\"}, \"\", 14 );"  ;
	setAttr ".rmt" -type "stringArray" 0  ;
	setAttr ".rio" -type "Int32Array" 2 0 0 ;
	setAttr -k on ".exitance" -type "float3" 0.02012665 0.02012665 0.02012665 ;
	setAttr ".exitance_multiplier" 1;
...
createNode liquidShader -n "liquidShader12";
	...
	addAttr -ci true -h true -sn "shininess_u" -ln "shininess_u" -at "double";
	addAttr -ci true -h true -sn "shininess_v" -ln "shininess_v" -at "double";
	setAttr ".rms" -type "string" "ashikhmin_brdf0";
	setAttr ".rst" -type "string" "ashikhmin_brdf";
	setAttr ".rml" -type "string" "E:/dev/Autodesk/maya/myplugin/project/liquid_/2.3.3/test/test_as_simple/ashikhminBRDF.dll";
	setAttr ".rpr" -type "stringArray" 6 "diffuse_reflectance" "diffuse_reflectance_multiplier" "glossy_reflectance" "glossy_reflectance_multiplier" "shininess_u" "shininess_v"  ;
	setAttr ".rdt" -type "stringArray" 6 "uniform" "uniform" "uniform" "uniform" "uniform" "uniform"  ;
	...
	setAttr ".diffuse_reflectance_multiplier" 1;
	setAttr -k on ".glossy_reflectance" -type "float3" 0 1 0 ;
	setAttr ".glossy_reflectance_multiplier" 1;
	setAttr ".shininess_u" 1000;
	setAttr ".shininess_v" 1000;
...
connectAttr "liquidShader10.oc" "liquidShader10SG.ss";
connectAttr "pPlaneShape1.iog" "liquidShader10SG.dsm" -na;
connectAttr "liquidShader11.oc" "liquidShader10SG.liqEDF";
connectAttr "liquidShader12.oc" "liquidShader10SG.liqBRDF";
connectAttr "liquidShader10SG.msg" "materialInfo12.sg";
connectAttr "liquidShader10.msg" "materialInfo12.m";
connectAttr "liquidShader10.msg" "materialInfo12.t" -na;
...
connectAttr "liquidShader10.msg" ":defaultShaderList1.s" -na;
...
// End of test_liqShaderNode_surface_as_ashikhminPSS.ma
