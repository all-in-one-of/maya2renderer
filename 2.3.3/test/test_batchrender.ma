...
//Name: test_batchrender.ma
//Last modified: Thu, Nov 18, 2010 06:48:25 PM
//Codeset: 936
requires maya "2009";
requires "liquid_2009x32d" "2.3.5";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -8.7619876807203134 14.555384884424257 26.202257897370348 ;
	setAttr ".r" -type "double3" -16.800000000001756 -10.000000000004272 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 36.109853804311172;
...
createNode turbulenceField -n "turbulenceField1";
	setAttr ".mag" 17.356000000000009;
	setAttr ".att" 0.8264800000000001;
	setAttr ".fc[0]"  0 1 1;
...
createNode script -n "sceneConfigurationScriptNode";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 16 -ast 1 -aet 600 ";
	setAttr ".st" 6;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".ddin[0]" -type "string" "img_$LYR_$F.tif";
...
createNode blinn -n "blinn1";
	setAttr ".c" -type "float3" 1 0 0.027999878 ;
...
select -ne :lambert1;
	setAttr ".c" -type "float3" 0.5 0.49350598 0.118 ;
...
select -ne :defaultRenderGlobals;
	...
	setAttr ".ef" 3;
	setAttr ".pff" yes;
	setAttr ".ifp" -type "string" "test_pointCloud2";
...
connectAttr "lambert33SG.msg" "lightLinker1.lnk[5].olnk";
...
connectAttr "lambert33SG.msg" "lightLinker1.slnk[7].solk";
