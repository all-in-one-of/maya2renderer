...
#ifndef liqGlobalHelpers_refactor_H
#define liqGlobalHelpers_refactor_H
...
LIQUID_EXPORT MString parseString_refactor( const MString & inputString, bool doEscaped = true );
...
#endif//liqGlobalHelpers_refactor_H
