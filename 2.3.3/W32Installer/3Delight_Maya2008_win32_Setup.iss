#include "liquidversion_3Delight_Maya2008_win32.iss"
...
begin
  ...
  if CurPage = wpFinished then begin
    if IsAdminLoggedOn() then begin
      InsertPath_NT(ExpandConstant('{app}\bin\maya2008\win32')+GetTargetRenderer, HKLM, 'SYSTEM\CurrentControlSet\Control\Session Manager\Environment', 'MAYA_PLUG_IN_PATH')
      ...
      InsertPath_NT(ExpandConstant('{app}\bin\maya2008\win32')+GetTargetRenderer, HKLM, 'SYSTEM\CurrentControlSet\Control\Session Manager\Environment', 'PATH')
      ...
      InsertPath_NT(ExpandConstant('{app}\bin\maya2008\win32')+GetTargetRenderer, HKCU, 'Environment', 'MAYA_PLUG_IN_PATH')
      InsertPath_NT(ExpandConstant('{app}\mel'), HKCU, 'Environment', 'MAYA_SCRIPT_PATH')
      InsertPath_NT(ExpandConstant('{app}\bin\maya2008\win32')+GetTargetRenderer, HKCU, 'Environment', 'PATH')
