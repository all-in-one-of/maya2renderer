...
public:
	...
	// current block (function) of code.
	//
	...
	//--------------------------------------------------------------------
	void addVariable(MString rslType, const MString& rslName,
		const MString& mayaName, const MString& mayaNode);
	
	//--------------------------------------------------------------------
	// Add a segment of code to the current block (function).
	//--------------------------------------------------------------------
	//void addTo(const MString& code);

	//--------------------------------------------------------------------
	// Begin a new block (function) of code.
	//--------------------------------------------------------------------
	void begin(const MString& name);

	//--------------------------------------------------------------------
	// End the current block (function) of code.
	//--------------------------------------------------------------------
	void end();
