...
#ifndef _RM_FLAT_NODE_H_
#define _RM_FLAT_NODE_H_
...
//	  static MObject aAssignedObjects;
	  ...
	  //shader parameters
	  static MObject aicolor;
	  static MObject aiopacity;

	bool    swatchInit;

private:
	FlatNode(const FlatNode&);
	FlatNode& operator=(const FlatNode&);
};
//
