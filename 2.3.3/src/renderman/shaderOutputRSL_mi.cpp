...
void Visitor::visit_mia_physicalsky(const char* node)
{
	...
	o.addRSLVariable("uniform", "bool",		"i_on",				"on",					node);
	...
	o.addRSLVariable("uniform", "bool", 	"i_use_background",		"use_background",		node);
	...
	o.addRSLVariable("uniform", "bool",		"i_y_is_up",			"y_is_up",				node);
