...
// static data
MTypeId liqShaderNode::id( liqShaderNodeId );

// Attributes
MObject liqShaderNode::aRmanShader;
MObject liqShaderNode::aRmanShaderType;
MObject liqShaderNode::aRmanShaderLong;
MObject liqShaderNode::aRmanShaderLif;
MObject liqShaderNode::aRmanParams;
MObject liqShaderNode::aRmanDetails;
MObject liqShaderNode::aRmanTypes;
MObject liqShaderNode::aRmanDefaults;
MObject liqShaderNode::aRmanArraySizes;
...
MObject liqShaderNode::aDisplacementBoundSpace;
MObject liqShaderNode::aOutputInShadow;

MObject liqShaderNode::aResolution;
MObject liqShaderNode::aRefreshPreview;
MObject liqShaderNode::aPreviewObjectSize;
MObject liqShaderNode::aPreviewShadingRate;
...
MObject liqShaderNode::aMayaKd;
MObject liqShaderNode::aNormalCameraX;
MObject liqShaderNode::aNormalCameraY;
MObject liqShaderNode::aNormalCameraZ;
MObject liqShaderNode::aNormalCamera;
MObject liqShaderNode::aLightDirectionX;
MObject liqShaderNode::aLightDirectionY;
MObject liqShaderNode::aLightDirectionZ;
MObject liqShaderNode::aLightDirection;
MObject liqShaderNode::aLightIntensityR;
MObject liqShaderNode::aLightIntensityG;
MObject liqShaderNode::aLightIntensityB;
MObject liqShaderNode::aLightIntensity;
MObject liqShaderNode::aLightAmbient;
MObject liqShaderNode::aLightDiffuse;
MObject liqShaderNode::aLightSpecular;
MObject liqShaderNode::aLightShadowFraction;
MObject liqShaderNode::aPreShadowIntensity;
MObject liqShaderNode::aLightBlindData;
...
void liqShaderNode::postConstructor( )
{
  setMPSafe(true);
...
void* liqShaderNode::creator()
{
    return new liqShaderNode();
}

MStatus liqShaderNode::initialize()
{
...
MStatus liqShaderNode::compute( const MPlug& plug, MDataBlock& block )
{
