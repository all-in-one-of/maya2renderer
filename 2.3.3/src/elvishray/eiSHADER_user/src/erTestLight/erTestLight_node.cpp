...
// static data
// Attributes
MObject TestLightNode::aRmanShader;
MObject TestLightNode::aRmanShaderType;
MObject TestLightNode::aRmanShaderLong;
MObject TestLightNode::aRmanShaderLif;
MObject TestLightNode::aRmanParams;
MObject TestLightNode::aRmanDetails;
MObject TestLightNode::aRmanTypes;
MObject TestLightNode::aRmanDefaults;
MObject TestLightNode::aRmanArraySizes;
MObject TestLightNode::aRmanLifCmds;
MObject TestLightNode::aRmanMethods;
MObject TestLightNode::aRmanIsOutput;  
MObject TestLightNode::aRmanAccept;

MObject TestLightNode::aOutColor;
MObject TestLightNode::aOutTransparency;
//MObject TestLightNode::aAssignedObjects;

MObject TestLightNode::alightcolor;
MObject TestLightNode::aintensity;
...
void TestLightNode::postConstructor( )
{
	setMPSafe(true);
...
const MTypeId TestLightNode::getTypeId()
{ 
	return UTI_TestLight_NODE;
}

const MString TestLightNode::getTypeName()
{ 
	return ("erTestLight");
}
...
void* TestLightNode::creator()
{
	return new TestLightNode();
}
