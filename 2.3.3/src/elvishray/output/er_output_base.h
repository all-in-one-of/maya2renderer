...
{	
	...
	public:
		...
		virtual eiTag ei_tab(const eiInt type, const eiUint nkeys, const eiInt items_per_slot) = 0;
		...
		virtual void ei_progressive( eiBool progressive ) = 0;
		...
		virtual void ei_trace_depth(eiInt transp, 
			...
			eiInt glossy_refract, eiInt diffuse_refract, eiInt sum) = 0;
		...
		virtual void ei_adaptive(const eiBool adaptive) = 0;
