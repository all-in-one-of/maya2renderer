...
//		if( trs != 0 )
//		{
//			varying color env_color = getGiEnvironmentSpecular(R, i_samples, i_blur);
//#ifdef USE_AOV_aov_env_specular
//			extern varying color aov_env_specular;
//			if( isoutput( aov_env_specular ) )
//			{
//				aov_env_specular +=	__transparency * env_color * trs * ray_coloration;
//			}
//#endif
//
...
//	normal Nf;
//	vector V;
//	uniform float i_refl_gloss;
//	uniform float i_refl_gloss_samples;
//	uniform float i_use_max_dist;
//	uniform float i_max_dist;
