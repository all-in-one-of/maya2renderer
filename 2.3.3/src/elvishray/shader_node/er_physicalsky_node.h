...
#ifndef _ER_PHYSICAL_SKY_NODE_H_
...
class PhysicalskyNode : public MPxNode
{
  public:
                      PhysicalskyNode();
    virtual          ~PhysicalskyNode();
...
private:
	PhysicalskyNode(const PhysicalskyNode&);
	PhysicalskyNode& operator=(const PhysicalskyNode&);
};


}//namespace

#endif//_ER_PHYSICAL_SKY_NODE_H_
