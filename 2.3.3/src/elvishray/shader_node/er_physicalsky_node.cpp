...
// static data
MTypeId PhysicalskyNode::id( TI_Physicalsky_NODE );

// Attributes
MObject PhysicalskyNode::aRmanShader;
MObject PhysicalskyNode::aRmanShaderType;
MObject PhysicalskyNode::aRmanShaderLong;
MObject PhysicalskyNode::aRmanShaderLif;
MObject PhysicalskyNode::aRmanParams;
MObject PhysicalskyNode::aRmanDetails;
MObject PhysicalskyNode::aRmanTypes;
MObject PhysicalskyNode::aRmanDefaults;
MObject PhysicalskyNode::aRmanArraySizes;
MObject PhysicalskyNode::aRmanLifCmds;
MObject PhysicalskyNode::aRmanMethods;
MObject PhysicalskyNode::aRmanIsOutput;  
MObject PhysicalskyNode::aRmanAccept;

MObject PhysicalskyNode::aPreviewPrimitive;
MObject PhysicalskyNode::aPreviewCustomPrimitive;
MObject PhysicalskyNode::aPreviewCustomBackplane;
MObject PhysicalskyNode::aPreviewCustomLightRig;
MObject PhysicalskyNode::aColor;
MObject PhysicalskyNode::aTransparency;
MObject PhysicalskyNode::aOpacity;
MObject PhysicalskyNode::aShaderSpace;
MObject PhysicalskyNode::aDisplacementBound;
MObject PhysicalskyNode::aDisplacementBoundSpace;
MObject PhysicalskyNode::aOutputInShadow;

MObject PhysicalskyNode::aResolution;
MObject PhysicalskyNode::aRefreshPreview;
MObject PhysicalskyNode::aPreviewObjectSize;
MObject PhysicalskyNode::aPreviewShadingRate;
MObject PhysicalskyNode::aPreviewBackplane;
MObject PhysicalskyNode::aPreviewIntensity;
MObject PhysicalskyNode::aGLPreviewTexture;
//MObject PhysicalskyNode::aCi;
//MObject PhysicalskyNode::aOi;

MObject PhysicalskyNode::aMayaIgnoreLights;
MObject PhysicalskyNode::aMayaKa;
MObject PhysicalskyNode::aMayaKd;
MObject PhysicalskyNode::aNormalCameraX;
MObject PhysicalskyNode::aNormalCameraY;
MObject PhysicalskyNode::aNormalCameraZ;
MObject PhysicalskyNode::aNormalCamera;
MObject PhysicalskyNode::aLightDirectionX;
MObject PhysicalskyNode::aLightDirectionY;
MObject PhysicalskyNode::aLightDirectionZ;
MObject PhysicalskyNode::aLightDirection;
MObject PhysicalskyNode::aLightIntensityR;
MObject PhysicalskyNode::aLightIntensityG;
MObject PhysicalskyNode::aLightIntensityB;
MObject PhysicalskyNode::aLightIntensity;
MObject PhysicalskyNode::aLightAmbient;
MObject PhysicalskyNode::aLightDiffuse;
MObject PhysicalskyNode::aLightSpecular;
MObject PhysicalskyNode::aLightShadowFraction;
MObject PhysicalskyNode::aPreShadowIntensity;
MObject PhysicalskyNode::aLightBlindData;
MObject PhysicalskyNode::aLightData;

MObject PhysicalskyNode::aEvaluateAtEveryFrame;
MObject PhysicalskyNode::aPreviewGamma;

MObject PhysicalskyNode::aOutColor;
MObject PhysicalskyNode::aOutTransparency;
...
void PhysicalskyNode::postConstructor( )
{
	setMPSafe(true);
	...
	//liquidMessage2(messageInfo, "PhysicalskyNode::postConstructor(), typeId=%d", typeId().id());
	//liquidMessage2(messageInfo, "PhysicalskyNode::postConstructor(), typeName=%s", typeName().asChar());
	//liquidMessage2(messageInfo, "PhysicalskyNode::postConstructor(), name=%s", name().asChar());
	//liquidMessage2(messageInfo, "PhysicalskyNode::postConstructor(), type=%d", type());

	//MFnDependencyNode depNode(MPxNode::thisMObject());
	//liquidMessage2(messageInfo, "PhysicalskyNode::postConstructor(), depNode.typeId=%d", depNode.typeId().id());
	//liquidMessage2(messageInfo, "PhysicalskyNode::postConstructor(), depNode.typeName=%s", depNode.typeName().asChar());
	//liquidMessage2(messageInfo, "PhysicalskyNode::postConstructor(), depNode.name=%s", depNode.name().asChar());
	//liquidMessage2(messageInfo, "PhysicalskyNode::postConstructor(), depNode.type=%d", depNode.type());
}

PhysicalskyNode::PhysicalskyNode()
{
	swatchInit = false;
	renderSwatch = NULL;
}
...
const MTypeId PhysicalskyNode::getTypeId()
{ 
	return TI_Physicalsky_NODE;
}

const MString PhysicalskyNode::getTypeName()
{ 
	return ("er_physicalsky");
}

void* PhysicalskyNode::creator()
{
	return new PhysicalskyNode();
}

MStatus PhysicalskyNode::initialize()
{
...
MStatus PhysicalskyNode::compute( const MPlug& plug, MDataBlock& block )
{
	//CM_TRACE_FUNC("PhysicalskyNode::compute(job="<<plug.name()<<",block)");
